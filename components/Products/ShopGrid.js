      ...
      <div className="list-product_item">
          <div className="single-product">
              ...
              <div className="product-content">
                  ...
                  <div className="add-actions">
                      <ul>
                          <li className="quick-view-btn" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">  <Link href='/products/product'><a  data-bs-toggle="tooltip" data-placement="top" title="Quick View"><i className="ion-ios-search"></i></a></Link>
                          </li>
                          <li>  <Link href='/wishlist'><a data-bs-toggle="tooltip" data-placement="top" title="Add To Wishlist"><i
                                  className="ion-ios-heart-outline"></i></a></Link>
                          </li>
                          <li>  <Link href='/products/product'><a data-bs-toggle="tooltip" data-placement="top" title="Add To Compare"><i className="ion-ios-reload"></i></a></Link>
                          </li>
                          <li>  <Link href='/cart'><a data-bs-toggle="tooltip" data-placement="top" title="Add To cart"><i className="ion-bag"></i></a></Link>
                          </li>
                      </ul>
                  </div>
              </div>
