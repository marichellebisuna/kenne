!(function (t, e) {
  ...
  const p = {
    ...
    i = (s, n, o) => {
      Object.keys(o).forEach((t) => {
        ...
        if (!new RegExp(e).test(i))
          throw new TypeError(
            `${s.toUpperCase()}: Option "${t}" provided type "${i}" but expected type "${e}".`
          );
      });
    },
    s = (t) =>
    ...
    _ = (i, n, t = !0) => {
      if (t) {
        ...
        const s = ({ target: t }) => {
          t === n &&
            ((e = !0), n.removeEventListener('transitionend', s), b(i));
        };
  ...
  function P(t, e, i, s, n) {
    if ('string' == typeof e && t) {
      ...
      const [h, u, d] = M(e, i, s),
        ...
        f = p[d] || (p[d] = {}),
        g = O(f, u, h ? i : null);
      if (g) return (g.oneOff = g.oneOff && n), 0;
      const m = A(u, e.replace(w, '')),
        v = h
          ? ((a = t),
            (l = i),
            (c = s),
  ...
  const L = {
      ...
      off(i, s, t, e) {
        if ('string' == typeof s && i) {
          const [n, o, r] = M(s, t, e),
            ...
            c = s.startsWith('.');
          if (void 0 !== o)
            return l && l[r] ? void N(i, l, r, o, n ? t : null) : void 0;
          c &&
            Object.keys(l).forEach((t) => {
              !(function (e, i, s, n) {
                ...
                Object.keys(o).forEach((t) => {
                  if (t.includes(n)) {
                    const n = o[t];
                    N(e, i, s, n.originalHandler, n.delegationSelector);
                  }
                });
              })(i, l, t, s.slice(1));
            });
          ...
          Object.keys(h).forEach((t) => {
            ...
            if (!a || s.includes(e)) {
              const s = h[t];
              N(i, l, r, s.originalHandler, s.delegationSelector);
            }
          });
        }
      },
      trigger(t, e, i) {
        ...
        return (
          ...
          r
            ? ((u = document.createEvent('HTMLEvents')), u.initEvent(n, l, !0))
  ...
  var j = function (t, e, i) {
    ...
    W = (t, e) => (z.has(t) && z.get(t).get(e)) || null,
    $ = function (t, e) {
      if (z.has(t)) {
        const i = z.get(t);
  ...
  class R {
    constructor(t) {
      (t = c(t)) &&
        ((this._element = t),
        j(this._element, this.constructor.DATA_KEY, this));
    }
    dispose() {
  ...
  class F extends R {
    ...
    _triggerCloseEvent(t) {
      return L.trigger(t, 'close.bs.alert');
    }
    _removeElement(t) {
    ...
    _destroyElement(t) {
      t.remove(), L.trigger(t, 'closed.bs.alert');
    }
  ...
  const U = {
      ...
      getDataAttribute: (t, e) => q(t.getAttribute('data-bs-' + Y(e))),
      offset(t) {
  ...
  class tt extends R {
    ...
    to(t) {
      ...
      if (!(t > this._items.length - 1 || t < 0))
        if (this._isSliding)
          L.one(this._element, 'slid.bs.carousel', () => this.to(t));
        else {
    ...
    _handleSwipe() {
      ...
      t <= 40 ||
        ...
        (this.touchDeltaX = 0),
        t && this._slide(0 < t ? J : G));
    }
    _addEventListeners() {
      this._config.keyboard &&
        L.on(this._element, 'keydown.bs.carousel', (t) => this._keydown(t)),
        'hover' === this._config.pause &&
          (L.on(this._element, 'mouseenter.bs.carousel', (t) => this.pause(t)),
          L.on(this._element, 'mouseleave.bs.carousel', (t) => this.cycle(t))),
        this._config.touch &&
          this._touchSupported &&
      ...
      p.find('.carousel-item img', this._element).forEach((t) => {
        ...
        this._pointerEvent
          ? (L.on(this._element, 'pointerdown.bs.carousel', (t) => e(t)),
            L.on(this._element, 'pointerup.bs.carousel', (t) => s(t)),
            this._element.classList.add('pointer-event'))
          : (L.on(this._element, 'touchstart.bs.carousel', (t) => e(t)),
            L.on(this._element, 'touchmove.bs.carousel', (t) => i(t)),
            L.on(this._element, 'touchend.bs.carousel', (t) => s(t)));
    }
    _keydown(t) {
      var e;
      /input|textarea/i.test(t.target.tagName) ||
        ((e = Z[t.key]) && (t.preventDefault(), this._slide(e)));
    }
    _getItemIndex(t) {
      return (
        (this._items =
          t && t.parentNode ? p.find('.carousel-item', t.parentNode) : []),
        this._items.indexOf(t)
      );
    }
    _getItemByOrder(t, e) {
      t = t === X;
      return y(this._items, e, t, this._config.wrap);
    }
    ...
    _slide(t, e) {
      ...
      if (o && o.classList.contains('active')) this._isSliding = !1;
        ...
        !this._isSliding &&
        !this._triggerSlideEvent(o, u).defaultPrevented &&
        s &&
        o
      ) {
        (this._isSliding = !0),
  ...
  L.on(
    ...
    L.on(window, 'load.bs.carousel.data-api', () => {
      ...
      for (let t = 0, e = i.length; t < e; t++)
        tt.carouselInterface(i[t], tt.getInstance(i[t]));
    }),
    t(tt);
  ...
  class st extends R {
    constructor(t, i) {
      ...
      for (let t = 0, e = s.length; t < e; t++) {
        const i = s[t],
          n = r(i),
          o = p.find(n).filter((t) => t === this._element);
        null !== n &&
          o.length &&
    ...
    show() {
      if (!this._isTransitioning && !this._element.classList.contains('show')) {
        ...
        if (t) {
          ...
          if (((e = p ? st.getInstance(p) : null), e && e._isTransitioning))
            return;
        }
    ...
    _getParent() {
      var t = this._config['parent'],
        e = `[data-bs-toggle="collapse"][data-bs-parent="${(t = c(t))}"]`;
      return (
        p.find(e, t).forEach((t) => {
          var e = n(t);
  ...
  L.on(
    ...
    function (t) {
      ('A' === t.target.tagName ||
        ...
        t.preventDefault();
      const s = U.getDataAttributes(this),
        e = r(this);
      p.find(e).forEach((t) => {
        const e = st.getInstance(t);
        let i;
        (i = e
          ? (null === e._parent &&
              'string' == typeof s.parent &&
              ((e._config.parent = s.parent), (e._parent = e._getParent())),
            'toggle')
          : s),
        ...
        function () {
          Object.keys(s.elements).forEach(function (t) {
            var e = s.elements[t],
              i = s.attributes[t] || {},
              t = Object.keys(
                (s.styles.hasOwnProperty(t) ? s.styles : n)[t]
              ).reduce(function (t, e) {
                return (t[e] = ''), t;
              }, {});
            gt(e) &&
  ...
  function Ct(t) {
    return 'html' === dt(t)
      ? t
      : t.assignedSlot || t.parentNode || (mt(t) ? t.host : null) || kt(t);
  }
  function Tt(t) {
    return gt(t) && 'fixed' !== xt(t).position ? t.offsetParent : null;
  }
  function St(t) {
    for (
      var e, i = pt(t), s = Tt(t);
      s &&
      ((e = s), 0 <= ['table', 'td', 'th'].indexOf(dt(e))) &&
      'static' === xt(s).position;
    ...
    return (
      ((!s ||
        ('html' !== dt(s) &&
          ('body' !== dt(s) || 'static' !== xt(s).position))) &&
        (s ||
          (function (t) {
  ...
  var Nt = {
      ...
      fn: function (t) {
        var e,
          ...
          l = bt(s.placement),
          c = Dt(l),
          h = 0 <= [at, rt].indexOf(l) ? 'height' : 'width';
        r &&
          a &&
          ((e = Mt(
            'number' !=
              typeof (i =
                'function' == typeof (i = o.padding)
                  ? i(Object.assign({}, s.rects, { placement: s.placement }))
                  : i)
              ? i
              : Pt(i, lt)
          )),
          ...
          (l = e[l]),
          (o = r - t[h] - e[o]),
          (o = Ot(l, (a = r / 2 - t[h] / 2 + (i / 2 - a / 2)), o)),
          (s.modifiersData[n] =
            (((n = {})[c] = o), (n.centerOffset = o - a), n)));
      },
      effect: function (t) {
        var e = t.state,
          t = t.options.element,
  ...
  function Lt(t) {
      ...
      d =
        !0 === u
          ? ((e = a.x),
            ...
            { x: It(It(e * s) / s) || 0, y: It(It(i * s) / s) || 0 })
          : 'function' == typeof u
          ? u(a)
          : a,
      p = d.x,
    ...
    h &&
      ...
      (g = 'clientWidth'),
      (a = St(n)) === pt(n) &&
        'static' !== xt((a = kt(n))).position &&
        ((d = 'scrollHeight'), (g = 'scrollWidth')),
      r === nt && ((u = ot), (t -= a[d] - o.height), (t *= c ? 1 : -1)),
      r === at && ((s = rt), (f -= a[g] - o.width), (f *= c ? 1 : -1)));
    var h = Object.assign({ position: l }, h && Ht);
    return c
      ? Object.assign(
          {},
          h,
    ...
    Wt = {
      ...
      effect: function (t) {
        var e = t.state,
          ...
          s = s.resize,
          o = void 0 === s || s,
          r = pt(e.elements.popper),
          a = [].concat(e.scrollParents.reference, e.scrollParents.popper);
        return (
          n &&
            a.forEach(function (t) {
              t.addEventListener('scroll', i.update, jt);
            }),
          o && r.addEventListener('resize', i.update, jt),
          function () {
            n &&
              a.forEach(function (t) {
                t.removeEventListener('scroll', i.update, jt);
              }),
              o && r.removeEventListener('resize', i.update, jt);
          }
        );
      },
      data: {},
  ...
  function Yt(t) {
    return _t(kt(t)).left + qt(t).scrollLeft;
  }
  function Ut(t) {
    var e = xt(t),
      i = e.overflow,
  ...
  function Vt(t, e) {
    ...
    var i = (function t(e) {
      ...
      s = pt(i),
      i = t ? [s].concat(s.visualViewport || [], Ut(i) ? i : []) : i,
      e = e.concat(i);
    return t ? e : e.concat(Vt(Ct(i)));
  }
  function Kt(t) {
      ...
      ? Kt(
          ...
          a &&
            ...
            /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ||
              ((o = a.offsetLeft), (r = a.offsetTop))),
          { width: l, height: c, x: o + Yt(n), y: r })
        )
      : gt(e)
      ? (((s = _t((i = e))).top = s.top + i.clientTop),
        (s.left = s.left + i.clientLeft),
        (s.bottom = s.top + i.clientHeight),
        (s.right = s.left + i.clientWidth),
        (s.width = i.clientWidth),
        (s.height = i.clientHeight),
        (s.x = s.left),
        (s.y = s.top),
        s)
      : Kt(
          ...
          (n = -e.scrollLeft + Yt(n)),
          (e = -e.scrollTop),
          'rtl' === xt(s || r).direction &&
            (n += Et(r.clientWidth, s ? s.clientWidth : 0) - t),
          { width: t, height: i, x: n, y: e })
        );
    var i, s, n, o, r, a, l, c;
  }
  function Qt(t) {
  ...
  function Jt(t, e) {
    var i,
      ...
      h = o.padding,
      d = void 0 === h ? 0 : h,
      r = Mt('number' != typeof d ? d : Pt(d, lt)),
      o = t.elements.reference,
      h = t.rects.popper,
      d = t.elements[l ? ('popper' === e ? 'reference' : 'popper') : e],
      d =
        ((i = ft(d) ? d : d.contextElement || kt(t.elements.popper)),
        (l = u),
        (d =
          'clippingParents' === (d = c)
            ? ((c = Vt(Ct((u = i)))),
              ft(
                (s =
                  0 <= ['absolute', 'fixed'].indexOf(xt(u).position) && gt(u)
                    ? St(u)
                    : u)
              )
                ? c.filter(function (t) {
                    return ft(t) && wt(t, s) && 'body' !== dt(t);
                  })
                : [])
            : [].concat(d)),
        (d = [].concat(d, [l])),
        ...
        ((l = d.reduce(function (t, e) {
          e = Xt(i, e);
          return (
            (t.top = Et(e.top, t.top)),
            (t.right = At(e.right, t.right)),
            (t.bottom = At(e.bottom, t.bottom)),
            (t.left = Et(e.left, t.left)),
            t
          );
        }, Xt(i, l))).width = l.right - l.left),
        (l.height = l.bottom - l.top),
        (l.x = l.left),
        (l.y = l.top),
        l),
      l = _t(o),
      o = Gt({ reference: l, element: h, strategy: 'absolute', placement: a }),
      o = Kt(Object.assign({}, h, o)),
      l = 'popper' === e ? o : l,
      p = {
        top: d.top - l.top + r.top,
        bottom: l.bottom - d.bottom + r.bottom,
        left: d.left - l.left + r.left,
        right: l.right - d.right + r.right,
      },
    ...
    return (
      'popper' === e &&
        ...
        Object.keys(p).forEach(function (t) {
          var e = 0 <= [rt, ot].indexOf(t) ? 1 : -1,
            i = 0 <= [nt, ot].indexOf(t) ? 'y' : 'x';
          p[t] += n[i] * e;
        })),
      p
    );
  ...
  var Zt = {
    ...
    fn: function (t) {
      ...
      if (!u.modifiersData[i]._skip) {
              ...
              return t.concat(
                'auto' === bt(e)
                  ? ((i = u),
                    ...
                    (a = n.padding),
                    (s = n.flipVariations),
                    (l = void 0 === (n = n.allowedAutoPlacements) ? ht : n),
                    (c = Qt(t)),
                    (t = c
                      ? s
                        ? ct
        ...
        u.placement !== b &&
          ((u.modifiersData[i]._skip = !0), (u.placement = b), (u.reset = !0));
      }
    },
    ...
    se = {
      ...
      fn: function (t) {
          ...
          t = ht.reduce(function (t, e) {
            return (
              (t[e] =
                ...
                (n = a),
                (o = bt(i)),
                (e = 0 <= [at, nt].indexOf(o) ? -1 : 1),
                (n =
                  (n = (i =
                    'function' == typeof n
                      ? n(Object.assign({}, s, { placement: i }))
                      : n)[0]) || 0),
                (i = ((i = i[1]) || 0) * e),
                0 <= [at, rt].indexOf(o) ? { x: i, y: n } : { x: n, y: i })),
              t
            );
            var i, s, n, o;
          }, {}),
        ...
        null != r.modifiersData.popperOffsets &&
          ...
          (r.modifiersData.popperOffsets.y += e)),
          (r.modifiersData[i] = t);
      },
    },
    ne = {
      ...
      fn: function (t) {
        ...
        x &&
          ((o || a) &&
            ...
            (g = 'start' === b ? -t[d] : -k[d]),
            (b = e.elements.arrow),
            (t = p && b ? yt(b) : { width: 0, height: 0 }),
            (f = (b = e.modifiersData['arrow#persistent']
              ? e.modifiersData['arrow#persistent'].padding
              : { top: 0, right: 0, bottom: 0, left: 0 })[f]),
            (c = b[c]),
            (t = Ot(0, k[d], t[d])),
            (f = _ ? k[d] / 2 - h - t - f - n : v - t - f - n),
            (t = _ ? -k[d] / 2 + h + t + c + n : g + t + c + n),
            (n = (c = e.elements.arrow && St(e.elements.arrow))
              ? 'y' === y
                ? c.clientTop || 0
                : c.clientLeft || 0
              : 0),
            ...
            (c = x[y] + t - c),
            o &&
              ((u = Ot(p ? At(l, n) : l, i, p ? Et(u, c) : u)),
              (x[y] = u),
              (r[y] = u - i)),
            a &&
              ((a = (i = x[w]) + m['x' === y ? nt : at]),
              (y = i - m['x' === y ? ot : rt]),
              (y = Ot(p ? At(a, n) : a, i, p ? Et(y, c) : y)),
              (x[w] = y),
              (r[w] = y - i))),
          (e.modifiersData[s] = r));
      },
          ...
          forceUpdate: function () {
            if (!h) {
              ...
              if (ae(e, t)) {
                        ...
                        (('body' === dt(e) && !Ut(s)) ||
                          (r =
                            (i = e) !== pt(i) && gt(i)
                              ...
                              : qt(i)),
                        gt(e)
                          ? (((t = _t(e)).x += e.clientLeft),
                            (t.y += e.clientTop))
                          : s && (t.x = Yt(s))),
                      {
                        x: n.left + r.scrollLeft - t.x,
                        y: n.top + r.scrollTop - t.y,
                        width: n.width,
                        height: n.height,
                      }
                    );
                  })(e, St(t), 'fixed' === l.options.strategy),
                  popper: yt(t),
                }),
                  (l.reset = !1),
                ...
                for (var i, s, n, o = 0; o < l.orderedModifiers.length; o++)
                  !0 !== l.reset
                    ? ((i = (n = l.orderedModifiers[o]).fn),
                      (s = n.options),
                      (n = n.name),
                      'function' == typeof i &&
                        (l =
  ...
  var ce = le(),
    he = le({ defaultModifiers: [Wt, ne, zt, vt] }),
    ue = le({ defaultModifiers: [Wt, ne, zt, vt, se, Zt, oe, Nt, ie] }),
    de = Object.freeze({
      __proto__: null,
      popperGenerator: le,
      detectOverflow: Jt,
  ...
  const pe = new RegExp('ArrowUp|ArrowDown|Escape'),
    fe = v() ? 'top-end' : 'top-start',
    ge = v() ? 'top-start' : 'top-end',
    me = v() ? 'bottom-end' : 'bottom-start',
    ve = v() ? 'bottom-start' : 'bottom-end',
    be = v() ? 'left-start' : 'right-start',
    _e = v() ? 'right-start' : 'left-start',
    ye = {
      offset: [0, 2],
  ...
  class xe extends R {
    ...
    show() {
      if (!h(this._element) && !this._menu.classList.contains('show')) {
        const e = xe.getParentFromElement(this._element),
        ...
        if (!L.trigger(this._element, 'show.bs.dropdown', t).defaultPrevented) {
          if (this._inNavbar) U.setDataAttribute(this._menu, 'popper', 'none');
            ...
            (this._popper = ue(t, this._menu, i)),
    ...
    _addEventListeners() {
      L.on(this._element, 'click.bs.dropdown', (t) => {
    ...
    static dataApiKeydownHandler(t) {
      if (
        ...
        if (
          ...
          return 'Escape' === t.key
            ? (i().focus(), void xe.clearMenus())
            : 'ArrowUp' === t.key || 'ArrowDown' === t.key
            ? (e || i().click(), void xe.getInstance(i())._selectMenuItem(t))
            : void ((e && 'Space' !== t.key) || xe.clearMenus());
        }
      }
    }
  }
  L.on(
    ...
    L.on(document, 'click.bs.dropdown.data-api', xe.clearMenus),
    L.on(document, 'keyup.bs.dropdown.data-api', xe.clearMenus),
    L.on(
      document,
  ...
  class ke {
    ...
    _applyManipulationCallback(t, e) {
      a(t) ? e(t) : p.find(t, this._element).forEach(e);
    }
    isOverflowing() {
  ...
  class Se {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Ce, ...('object' == typeof t ? t : {}) }).rootElement = c(
          t.rootElement
        )),
        i('backdrop', t, Te),
        t
    ...
    dispose() {
      this._isAppended &&
        (L.off(this._element, 'mousedown.bs.backdrop'),
  ...
  class Ae extends R {
    ...
    show(t) {
      this._isShown ||
        this._isTransitioning ||
        L.trigger(this._element, 'show.bs.modal', { relatedTarget: t })
          .defaultPrevented ||
        ((this._isShown = !0),
        ...
        L.on(this._dialog, 'mousedown.dismiss.bs.modal', () => {
      ...
      t && ['A', 'AREA'].includes(t.target.tagName) && t.preventDefault(),
        this._isShown &&
          ...
          (L.trigger(this._element, 'hide.bs.modal').defaultPrevented ||
            ...
            this._setEscapeEvent(),
            this._setResizeEvent(),
            L.off(document, 'focusin.bs.modal'),
            this._element.classList.remove('show'),
            L.off(this._element, 'click.dismiss.bs.modal'),
            L.off(this._dialog, 'mousedown.dismiss.bs.modal'),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._element.focus(),
              (this._isTransitioning = !1),
              L.trigger(this._element, 'shown.bs.modal', { relatedTarget: t });
          },
          this._dialog,
          e
        );
    ...
    _enforceFocus() {
      L.off(document, 'focusin.bs.modal'),
        L.on(document, 'focusin.bs.modal', (t) => {
          document === t.target ||
    ...
    _setResizeEvent() {
      this._isShown
        ? L.on(window, 'resize.bs.modal', () => this._adjustDialog())
        : L.off(window, 'resize.bs.modal');
    }
    _hideModal() {
      (this._element.style.display = 'none'),
        ...
        this._backdrop.hide(() => {
          document.body.classList.remove('modal-open'),
            ...
            L.trigger(this._element, 'hidden.bs.modal');
        });
    }
    _showBackdrop(t) {
      L.on(this._element, 'click.dismiss.bs.modal', (t) => {
    ...
    _triggerBackdropTransition() {
      if (
        !L.trigger(this._element, 'hidePrevented.bs.modal').defaultPrevented
      ) {
  ...
  L.on(
    ...
    function (t) {
      ...
      ['A', 'AREA'].includes(this.tagName) && t.preventDefault(),
        L.one(e, 'show.bs.modal', (t) => {
          t.defaultPrevented ||
            L.one(e, 'hidden.bs.modal', () => {
              s(this) && this.focus();
            });
        }),
  ...
  class Me extends R {
    ...
    show(t) {
      this._isShown ||
        ...
        this._backdrop.show(),
        this._config.scroll ||
          (new ke().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute('aria-hidden'),
        this._element.setAttribute('aria-modal', !0),
        this._element.setAttribute('role', 'dialog'),
        this._element.classList.add('show'),
    ...
    hide() {
      this._isShown &&
        (L.trigger(this._element, 'hide.bs.offcanvas').defaultPrevented ||
          (L.off(document, 'focusin.bs.offcanvas'),
          this._element.blur(),
          (this._isShown = !1),
          this._element.classList.remove('show'),
          this._backdrop.hide(),
          this._queueCallback(
            () => {
              this._element.setAttribute('aria-hidden', !0),
                ...
                L.trigger(this._element, 'hidden.bs.offcanvas');
            },
            this._element,
            !0
          )));
    ...
    _enforceFocusOnElement(e) {
      L.off(document, 'focusin.bs.offcanvas'),
        L.on(document, 'focusin.bs.offcanvas', (t) => {
          document === t.target ||
            e === t.target ||
            e.contains(t.target) ||
            e.focus();
  ...
  L.on(
    ...
    function (t) {
      ...
      ['A', 'AREA'].includes(this.tagName) && t.preventDefault(),
        h(this) ||
          (L.one(e, 'hidden.bs.offcanvas', () => {
            s(this) && this.focus();
          }),
          (t = p.findOne('.offcanvas.show')) &&
            t !== e &&
            Me.getInstance(t).hide(),
          Me.getOrCreateInstance(e).toggle(this));
    }
  ),
    L.on(window, 'load.bs.offcanvas.data-api', () =>
      p.find('.offcanvas.show').forEach((t) => Me.getOrCreateInstance(t).show())
    ),
    t(Me);
  const Pe = new Set([
      'background',
        ...
        a.forEach((t) => {
          ((t, e) => {
            ...
            if (e.includes(i))
              return (
                !Pe.has(i) ||
                Boolean(Ne.test(t.nodeValue) || He.test(t.nodeValue))
              );
  ...
  class Be extends R {
    ...
    show() {
      ...
      if (this.isWithContent() && this._isEnabled) {
        const e = L.trigger(this._element, this.constructor.Event.SHOW),
          i = u(this._element),
          s = (
        ...
        if (!e.defaultPrevented && s) {
          ...
          j(n, this.constructor.DATA_KEY, this),
            this._element.ownerDocument.documentElement.contains(this.tip) ||
              (r.appendChild(n),
              L.trigger(this._element, this.constructor.Event.INSERTED)),
            this._popper
              ? this._popper.update()
              : (this._popper = ue(this._element, n, this._getPopperConfig(t))),
    ...
    hide() {
      if (this._popper) {
        ...
        var t;
        L.trigger(this._element, this.constructor.Event.HIDE)
          .defaultPrevented ||
    ...
    setContent() {
      ...
      this.setElementContent(p.findOne('.tooltip-inner', t), this.getTitle()),
        ...
        return a(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = Le(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || W(t.delegateTarget, i)) ||
          ((e = new this.constructor(
            t.delegateTarget,
            this._getDelegateConfig()
          )),
          j(t.delegateTarget, i, e)),
        e
      );
    }
    _getOffset() {
    ...
    _getConfig(t) {
      ...
      return (
        ...
        t.sanitize && (t.template = Le(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
    ...
    getTipElement() {
      return (
        this.tip ||
          ...
          this._getContent() || p.findOne('.popover-body', this.tip).remove()),
        this.tip
      );
    }
    setContent() {
      ...
      'function' == typeof e && (e = e.call(this._element)),
        this.setElementContent(p.findOne('.popover-body', t), e),
        t.classList.remove('fade', 'show');
    }
    _addAttachmentClass(t) {
      this.getTipElement().classList.add(
  ...
  class Ge extends R {
    constructor(t, e) {
      super(t),
        ...
        L.on(this._scrollElement, 'scroll.bs.scrollspy', () => this._process()),
        this.refresh(),
        this._process();
    }
    static get Default() {
        ...
        p
          ...
          .map((t) => {
            ...
            if (i) {
              ...
              if (p.width || p.height) return [U[s](i).top + n, e];
            }
            return null;
          })
          .filter((t) => t)
    ...
    _activate(e) {
      ...
      i.classList.contains('dropdown-item')
        ...
        : (i.classList.add('active'),
          p.parents(i, '.nav, .list-group').forEach((t) => {
            p
              .prev(t, '.nav-link, .list-group-item')
              .forEach((t) => t.classList.add('active')),
              p.prev(t, '.nav-item').forEach((t) => {
                p.children(t, '.nav-link').forEach((t) =>
  ...
  L.on(window, 'load.bs.scrollspy.data-api', () => {
    p.find('[data-bs-spy="scroll"]').forEach((t) => new Ge(t));
  }),
    t(Ge);
  class Je extends R {
    static get NAME() {
  ...
  (function (t, e) {
    ...
    (C.fn = C.prototype =
            ...
            if (null != (t = arguments[r]))
              for (e in t)
                (i = t[e]),
                  '__proto__' !== e &&
                    o !== i &&
                    (l && i && (C.isPlainObject(i) || (s = Array.isArray(i)))
                      ? ((n = o[e]),
                        (n =
                          s && !Array.isArray(n)
                            ? []
      ...
      C.extend({
        ...
        each: function (t, e) {
          ...
          else for (s in t) if (!1 === e.call(t[s], s, t[s])) break;
          return t;
        },
        ...
        grep: function (t, e, i) {
          for (var s = [], n = 0, o = t.length, r = !i; n < o; n++)
    ...
    var d = (function (i) {
      ...
      try {
        L.apply((e = z.call(_.childNodes)), _.childNodes),
      ...
      function at(t, e, i, s) {
        ...
        if (!s && (x(e), (e = e || k), C)) {
          if (11 !== u && (a = it.exec(t)))
            if ((c = a[1])) {
              if (9 === u) {
                if (!(o = e.getElementById(c))) return i;
                if (o.id === c) return i.push(o), i;
              } else if (
                h &&
                (o = h.getElementById(c)) &&
                b(e, o) &&
                o.id === c
              )
                return i.push(o), i;
              ...
              if (
                ...
                return L.apply(i, e.getElementsByClassName(c)), i;
            }
          if (
            p.qsa &&
            !O[t + ' '] &&
            ...
            if (((c = t), (h = e), 1 === u && (K.test(t) || V.test(t)))) {
              for (
                ((h = (st.test(t) && gt(e.parentNode)) || e) === e &&
                  p.scope) ||
                  ((r = e.getAttribute('id'))
                    ? (r = r.replace(ot, d))
        ...
        return m(t.replace(Y, '$1'), e, i, s);
      }
      function lt() {
        var s = [];
        return function t(e, i) {
          return (
            s.push(e + ' ') > y.cacheLength && delete t[s.shift()],
            (t[e + ' '] = i)
          );
        };
      }
      ...
      function ft(r) {
        return ct(function (o) {
          return (
            (o = +o),
            ct(function (t, e) {
              for (var i, s = r([], t.length, o), n = s.length; n--; )
                t[(i = s[n])] && (t[i] = !(e[i] = t[i]));
            })
          );
        });
      ...
      (x = at.setDocument =
        function (t) {
          var e,
            t = t ? t.ownerDocument || t : _;
          return (
            t != k &&
              9 === t.nodeType &&
              t.documentElement &&
              ((r = (k = t).documentElement),
              (C = !n(k)),
              _ != k &&
                (e = k.defaultView) &&
                e.top !== e &&
                (e.addEventListener
                  ? e.addEventListener('unload', s, !1)
                  : e.attachEvent && e.attachEvent('onunload', s)),
              (p.scope = ht(function (t) {
                return (
                  r.appendChild(t).appendChild(k.createElement('div')),
              ...
              (p.getElementsByClassName = et.test(k.getElementsByClassName)),
              ...
              (a = []),
              (v = []),
              (p.qsa = et.test(k.querySelectorAll)) &&
                (ht(function (t) {
                  var e;
                    ...
                    return t === e
                      ...
                      : (i =
                          ...
                          (!p.sortDetached &&
                            ...
                            ? t == k || (t.ownerDocument == _ && b(_, t))
                              ? -1
                              : e == k || (e.ownerDocument == _ && b(_, e))
                              ? 1
                              : l
                              ? j(l, t) - j(l, e)
                              : 0
      ...
      (at.contains = function (t, e) {
        return (t.ownerDocument || t) != k && x(t), b(t, e);
      }),
      (at.attr = function (t, e) {
        (t.ownerDocument || t) != k && x(t);
        var i = y.attrHandle[e.toLowerCase()],
          i = i && P.call(y.attrHandle, e.toLowerCase()) ? i(t, e, !C) : void 0;
        return void 0 !== i
          ? i
          : p.attributes || !C
          ? t.getAttribute(e)
      ...
      ((y = at.selectors =
        {
                ...
                return null == t
                  ...
                  : !i ||
                      ...
                      '=' === i
                        ...
                        : '~=' === i
                        ? -1 < (' ' + t.replace(q, ' ') + ' ').indexOf(s)
                        : '|=' === i &&
                          (t === s || t.slice(0, s.length + 1) === s + '-'));
              };
            },
              ...
              return r[T]
                ...
                ? ((e = [t, t, '', o]),
                  y.setFilters.hasOwnProperty(t.toLowerCase())
                    ? ct(function (t, e) {
                        for (var i, s = r(t, o), n = s.length; n--; )
                          t[(i = j(t, s[n]))] = !(e[i] = s[n]);
                      })
                    : function (t) {
                        return r(t, 0, e);
          ...
          pseudos: {
            not: ct(function (t) {
              ...
              return a[T]
                ? ct(function (t, e, i, s) {
                    for (var n, o = a(t, null, s, []), r = t.length; r--; )
                      (n = o[r]) && (t[r] = !(e[r] = n));
                  })
                : function (t, e, i) {
                    return (
                      (s[0] = t), a(s, null, i, n), (s[0] = null), !n.pop()
                    );
                  };
            }),
            has: ct(function (e) {
      ...
      function bt(r, t, e) {
        ...
        return t.first
          ...
          : function (t, e, i) {
              ...
              if (i) {
                for (; (t = t[a]); )
                  if ((1 === t.nodeType || h) && r(t, e, i)) return !0;
              } else
                for (; (t = t[a]); )
                  if (1 === t.nodeType || h)
                    if (
                      ((s =
                        (n = t[T] || (t[T] = {}))[t.uniqueID] ||
                        (n[t.uniqueID] = {})),
                      l && l === t.nodeName.toLowerCase())
                    )
                      t = t[a] || t;
                    else {
                      if ((n = s[c]) && n[0] === S && n[1] === u)
                        return (o[2] = n[2]);
      ...
      function yt(t, e, i, s, n) {
        for (var o, r = [], a = 0, l = t.length, c = null != e; a < l; a++)
          (o = t[a]) && ((i && !i(o, s, n)) || (r.push(o), c && e.push(a)));
        return r;
      }
      function wt(t) {
        for (
          var s,
            ...
            h = [
              function (t, e, i) {
                i =
                  (!o && (i || e !== w)) || ((s = e).nodeType ? l : c)(t, e, i);
                return (s = null), i;
              },
            ];
          a < n;
          ...
          if ((e = y.relative[t[a].type])) h = [bt(_t(h), e)];
          else {
                ...
                return (
                  ...
                  ct(function (t, e, i, s) {
                    var n,
                      ...
                      u = !p || (!t && f) ? h : yt(h, a, p, i, s),
                      d = g ? (v || (t ? p : c || m) ? [] : e) : u;
                    if ((g && g(u, d, i, s), m))
                      for (n = yt(d, l), m(n, [], i, s), o = n.length; o--; )
                        (r = n[o]) && (d[l[o]] = !(u[l[o]] = r));
                    if (t) {
                      if (v || p) {
                        if (v) {
                    ...
                    } else (d = yt(d === e ? d.splice(c, d.length) : d)), v ? v(null, e, d, s) : L.apply(e, d);
                  })
                );
              })(
                1 < a && _t(h),
        ...
        (f = at.tokenize =
          function (t, e) {
            ...
            for (r = t, a = [], l = y.preFilter; r; ) {
              for (o in ((i && !(s = U.exec(r))) ||
                (s && (r = r.slice(s[0].length) || r), a.push((n = []))),
              (i = !1),
              (s = V.exec(r)) &&
                ((i = s.shift()),
                n.push({ value: i, type: s[0].replace(Y, ' ') }),
                (r = r.slice(i.length))),
              y.filter))
                !(s = G[o].exec(r)) ||
                  (l[o] && !(s = l[o](s))) ||
                  ((i = s.shift()),
                  n.push({ value: i, type: o, matches: s }),
                  (r = r.slice(i.length)));
              if (!i) break;
            }
              ...
              (r = I(
                ...
                (s = function (t, e, i, s, n) {
                  ...
                  for (
                    ...
                    if (_ && o) {
                      for (
                        r = 0, e || o.ownerDocument == k || (x(o), (i = !C));
                        (a = m[r++]);
        ...
        (m = at.select =
          function (t, e, i, s) {
            ...
            if (((i = i || []), 1 === h.length)) {
              ...
              for (
                n = G.needsContext.test(t) ? 0 : o.length;
                ...
                if (
                  ...
                  (s = l(
                    ...
                    (st.test(o[0].type) && gt(e.parentNode)) || e
                  ))
                ) {
                  if ((o.splice(n, 1), !(t = s.length && vt(o))))
      ...
      C.fn.extend({
        find: function (t) {
          ...
          if ('string' != typeof t)
            return this.pushStack(
              C(t).filter(function () {
                for (e = 0; e < s; e++) if (C.contains(n[e], this)) return !0;
              })
            );
          for (i = this.pushStack([]), e = 0; e < s; e++) C.find(t, n[e], i);
        ...
        is: function (t) {
          return !!E(
            this,
            'string' == typeof t && T.test(t) ? C(t) : t || [],
            !1
          ).length;
        },
      });
    ...
    (C.fn.init = function (t, e, i) {
      ...
      if (s[1]) {
        if (
          ...
          C.merge(
            this,
            C.parseHTML(s[1], e && e.nodeType ? e.ownerDocument || e : k, !0)
          ),
          D.test(s[1]) && C.isPlainObject(e))
        )
          for (var s in e) g(this[s]) ? this[s](e[s]) : this.attr(s, e[s]);
        return this;
      }
      return (
        (t = k.getElementById(s[2])) && ((this[0] = t), (this.length = 1)), this
      );
    }).prototype = C.fn;
    var I = C(k),
    ...
    C.fn.extend({
      ...
      C.each(
        ...
        function (s, n) {
          C.fn[s] = function (t, e) {
            var i = C.map(this, n, t);
            return (
              (e = 'Until' !== s.slice(-5) ? t : e) &&
                'string' == typeof e &&
                (i = C.filter(e, i)),
              1 < this.length &&
                (M[s] || C.uniqueSort(i), O.test(s) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
    ...
    (C.Callbacks = function (s) {
      ...
      s =
        'string' == typeof s
          ...
          : C.extend({}, s);
      function n() {
        for (a = a || s.once, r = o = !0; c.length; h = -1)
          for (e = c.shift(); ++h < l.length; )
            !1 === l[h].apply(e[0], e[1]) &&
              s.stopOnFalse &&
              ((h = l.length), (e = !1));
        s.memory || (e = !1), (o = !1), a && (l = e ? [] : '');
      }
      var o,
        e,
        r,
      ...
      C.extend({
            ...
            r = {
              ...
              then: function (e, i, s) {
                ...
                return C.Deferred(function (t) {
                  o[0][3].add(c(0, t, g(s) ? s : H, t.notifyWith)),
                    o[1][3].add(c(0, t, g(e) ? e : H)),
                    o[2][3].add(c(0, t, g(i) ? i : L));
                }).promise();
              },
              promise: function (t) {
        ...
        when: function (t) {
          ...
          if (
            i <= 1 &&
            (z(t, r.done(e(s)).resolve, r.reject, !i),
            'pending' === r.state() || g(o[s] && o[s].then))
          )
            return r.then();
          for (; s--; ) z(o[s], e(s), r.reject);
          return r.promise();
        },
      });
    ...
    function R(t, e, i, s, n, o, r) {
      var a = 0,
        ...
        c = null == i;
      if ('object' === f(i))
        for (a in ((n = !0), i)) R(t, e, a, i[a], !0, o, r);
      else if (
        void 0 !== s &&
        ((n = !0),
        g(s) || (r = !0),
    ...
    function Y(t) {
      return t.replace(F, 'ms-').replace(B, q);
    }
    function U(t) {
    ...
    function J(t, e, i) {
      ...
      if (void 0 === i && 1 === t.nodeType)
        if (
          ((s = 'data-' + e.replace(G, '-$&').toLowerCase()),
    ...
    C.extend({
      ...
      C.fn.extend({
        data: function (i, t) {
            ...
            return 'object' == typeof i
              ...
              : R(
                  ...
                  function (t) {
                    var e;
                    return o && void 0 === t
                      ? void 0 !== (e = X.get(o, i)) || void 0 !== (e = J(o, i))
                        ? e
                        : void 0
          ...
          if (
            this.length &&
            ((n = X.get(o)), 1 === o.nodeType && !K.get(o, 'hasDataAttrs'))
          ) {
            for (e = r.length; e--; )
              r[e] &&
                0 === (s = r[e].name).indexOf('data-') &&
                ((s = Y(s.slice(5))), J(o, s, n[s]));
      ...
      C.extend({
        queue: function (t, e, i) {
          ...
          if (t)
            return (
              (s = K.get(t, (e = (e || 'fx') + 'queue'))),
              i &&
                (!s || Array.isArray(i)
                  ? (s = K.access(t, e, C.makeArray(i)))
                  : s.push(i)),
              s || []
            );
        },
    ...
    it.getRootNode &&
      (st = function (t) {
        return (
          ...
          t.getRootNode(nt) === t.ownerDocument
        );
      });
    function ot(t, e) {
      return (
    ...
    var at = {};
    function lt(t, e) {
      for (var i, s, n, o, r, a, l = [], c = 0, h = t.length; c < h; c++)
        (s = t[c]).style &&
          ((i = s.style.display),
          e
            ? ('none' === i &&
                ((l[c] = K.get(s, 'display') || null),
                l[c] || (s.style.display = '')),
              '' === s.style.display &&
                ot(s) &&
                (l[c] =
                  ...
                  (r = s.nodeName),
                  (a = at[r]) ||
                    ((n = o.body.appendChild(o.createElement(r))),
                    (a = C.css(n, 'display')),
                    n.parentNode.removeChild(n),
                    (at[r] = a = 'none' === a ? 'block' : a)))))
            : 'none' !== i && ((l[c] = 'none'), K.set(s, 'display', i)));
    ...
    var ct = /^(?:checkbox|radio)$/i,
      ...
      dt = k.createDocumentFragment().appendChild(k.createElement('div'));
    ...
    function vt(t, e, i, s, n) {
          ...
          if ('object' === f(o)) C.merge(u, o.nodeType ? [o] : o);
            ...
            for (
              r = r || h.appendChild(e.createElement('div')),
                ...
                a = pt[a] || pt._default,
                r.innerHTML = a[1] + C.htmlPrefilter(o) + a[2],
                c = a[0];
              c--;
      ...
      for (h.textContent = '', d = 0; (o = u[d++]); )
        if (s && -1 < C.inArray(o, s)) n && n.push(o);
        else if (
          ((l = st(o)), (r = ft(h.appendChild(o), 'script')), l && gt(r), i)
        )
    ...
    function xt(t, e, i, s, n, o) {
      var r, a;
      if ('object' == typeof e) {
        for (a in ('string' != typeof i && ((s = s || i), (i = void 0)), e))
          xt(t, a, i, s, e[a], o);
        return t;
      }
      if (
    ...
    function kt(t, n, o) {
      o
          ...
          C.event.add(t, n, {
            ...
            handler: function (t) {
              ...
              if (1 & t.isTrigger && this[n]) {
                if (s.length)
                  (C.event.special[n] || {}).delegateType &&
                    t.stopPropagation();
                else if (
                  ((s = a.call(arguments)),
                  K.set(this, n, s),
        ...
        : void 0 === K.get(t, n) && C.event.add(t, n, _t);
    }
    (C.event = {
      global: {},
      add: function (e, t, i, s, n) {
        ...
        if (U(e))
          for (
            i.handler && ((i = (o = i).handler), (n = o.selector)),
              n && C.find.matchesSelector(it, n),
            ...
            (u = p = (c = bt.exec(t[l]) || [])[1]),
              ...
              u &&
                ...
                (p = a[u]) ||
                  ...
                  (h.setup && !1 !== h.setup.call(e, s, d, r)) ||
        ...
        if (m && (l = m.events)) {
          for (c = (e = (e || '').match(N) || ['']).length; c--; )
            if (
              ...
              for (
                u = C.event.special[p] || {},
                  d = l[(p = (s ? u.delegateType : u.bindType) || p)] || [],
                  a =
                    a[2] &&
                    new RegExp('(^|\\.)' + f.join('\\.(?:.*\\.|)') + '(\\.|$)'),
                  r = o = d.length;
              ...
              r &&
                ...
                delete l[p]);
            } else for (p in l) C.event.remove(t, p + e[c], i, s, !0);
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            o = C.event.handlers.call(this, a, l), e = 0;
            (s = o[e++]) && !a.isPropagationStopped();

          )
            for (
              a.currentTarget = s.elem, i = 0;
              (n = s.handlers[i++]) && !a.isImmediatePropagationStopped();
              ...
              (a.rnamespace &&
                ...
                void 0 !==
                  (n = (
                    (C.event.special[n.origType] || {}).handle || n.handler
                  ).apply(s.elem, r)) &&
                  !1 === (a.result = n) &&
        ...
        if (l && c.nodeType && !('click' === t.type && 1 <= t.button))
          for (; c !== this; c = c.parentNode || this)
            if (1 === c.nodeType && ('click' !== t.type || !0 !== c.disabled)) {
              for (o = [], r = {}, i = 0; i < l; i++)
                void 0 === r[(n = (s = e[i]).selector + ' ')] &&
                  (r[n] = s.needsContext
                    ? -1 < C(n, this).index(c)
                    : C.find(n, this, null, [c]).length),
                  r[n] && o.push(s);
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            t = this || t;
            return (
              ct.test(t.type) && t.click && S(t, 'input') && kt(t, 'click', _t),
              !1
            );
          },
          trigger: function (t) {
            t = this || t;
            return (
              ct.test(t.type) && t.click && S(t, 'input') && kt(t, 'click'), !0
            );
          },
          _default: function (t) {
            t = t.target;
      ...
      C.fn.extend({
        on: function (t, e, i, s) {
          return xt(this, t, e, i, s);
        },
        one: function (t, e, i, s) {
          return xt(this, t, e, i, s, 1);
        },
        off: function (t, e, i) {
          var s, n;
    ...
    function It(t, e) {
      ...
      if (1 === e.nodeType) {
        if (K.hasData(t) && (o = K.get(t).events))
          for (n in (K.remove(e, 'handle events'), o))
            for (i = 0, s = o[n].length; i < s; i++) C.event.add(e, n, o[n][i]);
    ...
    function Ot(i, s, n, o) {
      ...
      var t,
        ...
        p = s[0],
        f = g(p);
      if (f || (1 < u && 'string' == typeof p && !_.checkClone && Tt.test(p)))
      ...
      if (
        u &&
        ((e = (t = vt(s, i[0].ownerDocument, !1, i, o)).firstChild),
        1 === t.childNodes.length && (t = e),
        e || o)
      ) {
        for (a = (r = C.map(ft(t, 'script'), Et)).length; h < u; h++)
          (l = t),
            h !== d &&
              ((l = C.clone(l, !0, !0)), a && C.merge(r, ft(l, 'script'))),
            n.call(i[h], l, h);
        if (a)
          for (
            c = r[r.length - 1].ownerDocument, C.map(r, At), h = 0;
            h < a;
            h++
          )
            (l = r[h]),
              ut.test(l.type || '') &&
                ...
                (l.src && 'module' !== (l.type || '').toLowerCase()
                  ...
                  : y(l.textContent.replace(St, ''), l, c));
      }
      return i;
    }
    function Mt(t, e, i) {
      for (var s, n = e ? C.filter(e, t) : t, o = 0; null != (s = n[o]); o++)
        i || 1 !== s.nodeType || C.cleanData(ft(s)),
          s.parentNode &&
            (i && st(s) && gt(ft(s, 'script')), s.parentNode.removeChild(s));
      return t;
    }
    C.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (
          ...
          for (r = ft(h), s = 0, n = (o = ft(t)).length; s < n; s++)
            (a = o[s]),
        ...
        if (e)
          if (i)
            for (
              o = o || ft(t), r = r || ft(h), s = 0, n = o.length;
              s < n;
              s++
            )
              It(o[s], r[s]);
        ...
        return (
          0 < (r = ft(h, 'script')).length && gt(r, !u && ft(t, 'script')), h
        );
      },
      cleanData: function (t) {
        for (
          var e, i, s, n = C.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        )
          if (U(i)) {
            if ((e = i[K.expando])) {
              if (e.events)
                for (s in e.events)
                  n[s] ? C.event.remove(i, s) : C.removeEvent(i, s, e.handle);
              i[K.expando] = void 0;
            }
      ...
      C.fn.extend({
        ...
        empty: function () {
          for (var t, e = 0; null != (t = this[e]); e++)
            1 === t.nodeType && (C.cleanData(ft(t, !1)), (t.textContent = ''));
          return this;
        },
        clone: function (t, e) {
          return (
          ...
          return R(
            ...
            function (t) {
              ...
              if (
                'string' == typeof t &&
                !Ct.test(t) &&
                !pt[(ht.exec(t) || ['', ''])[1].toLowerCase()]
              ) {
                t = C.htmlPrefilter(t);
                try {
                  for (; i < s; i++)
                    1 === (e = this[i] || {}).nodeType &&
                      (C.cleanData(ft(e, !1)), (e.innerHTML = t));
                  e = 0;
                } catch (t) {}
              }
        ...
        replaceWith: function () {
          ...
          return Ot(
            ...
            function (t) {
              ...
              C.inArray(this, i) < 0 &&
                (C.cleanData(ft(this)), e && e.replaceChild(t, this));
            },
            i
          );
        },
      ...
      C.each(
        ...
        function (t, r) {
          C.fn[t] = function (t) {
            for (var e, i = [], s = C(t), n = s.length - 1, o = 0; o <= n; o++)
              (e = o === n ? this : this.clone(!0)),
                C(s[o])[r](e),
                l.apply(i, e.get());
    ...
    function Nt(t, e, i) {
      var s,
        n = {};
      for (s in e) (n[s] = t.style[s]), (t.style[s] = e[s]);
      for (s in ((i = i.call(t)), e)) t.style[s] = n[s];
      return i;
    }
    var Ht,
      Lt,
    ...
    function Vt() {
      ...
      Ft &&
        ...
        it.appendChild(Rt).appendChild(Ft),
        (t = x.getComputedStyle(Ft)),
        (Ht = '1%' !== t.top),
        ($t = 12 === Kt(t.marginLeft)),
        (Ft.style.right = '60%'),
        (jt = 36 === Kt(t.right)),
        (Lt = 36 === Kt(t.width)),
        (Ft.style.position = 'absolute'),
        (zt = 12 === Kt(Ft.offsetWidth / 3)),
        it.removeChild(Rt),
        (Ft = null));
    }
    function Kt(t) {
    ...
    (Rt = k.createElement('div')),
      (Ft = k.createElement('div')).style &&
        ((Ft.style.backgroundClip = 'content-box'),
        (Ft.cloneNode(!0).style.backgroundClip = ''),
        (_.clearCloneStyle = 'content-box' === Ft.style.backgroundClip),
        C.extend(_, {
    ...
    function ne(t, e, i, s, n, o) {
      ...
      for (; r < 4; r += 2)
        'margin' === i && (l += C.css(t, i + et[r], !0, n)),
          s
            ? ('content' === i && (l -= C.css(t, 'padding' + et[r], !0, n)),
              'margin' !== i &&
                (l -= C.css(t, 'border' + et[r] + 'Width', !0, n)))
            : ((l += C.css(t, 'padding' + et[r], !0, n)),
              'padding' !== i
                ? (l += C.css(t, 'border' + et[r] + 'Width', !0, n))
                : (a += C.css(t, 'border' + et[r] + 'Width', !0, n)));
      return (
        !s &&
          0 <= o &&
          (l +=
    ...
    function oe(t, e, i) {
      var s = Pt(t),
        n =
          ...
          'border-box' === C.css(t, 'boxSizing', !1, s),
        o = n,
        r = Yt(t, e, s),
      ...
      return (
        ((!_.boxSizingReliable() && n) ||
          (!_.reliableTrDimensions() && S(t, 'tr')) ||
          'auto' === r ||
          (!parseFloat(r) && 'inline' === C.css(t, 'display', !1, s))) &&
          t.getClientRects().length &&
          ((n = 'border-box' === C.css(t, 'boxSizing', !1, s)),
          (o = a in t) && (r = t[a])),
        (r = parseFloat(r) || 0) +
    ...
    C.extend({
      ...
      style: function (t, e, i, s) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          ...
          if (
            ...
            return r && 'get' in r && void 0 !== (n = r.get(t, !1, s))
              ? n
              : c[e];
          'string' == (o = typeof i) &&
            (n = tt.exec(i)) &&
        ...
        return (
          ...
          'normal' ===
            (n =
              void 0 ===
              (n =
                (o = C.cssHooks[e] || C.cssHooks[o]) && 'get' in o
                  ? o.get(t, !0, i)
                  : n)
                ? Yt(t, e, s)
                : n) &&
      ...
      C.each(['height', 'width'], function (t, a) {
        C.cssHooks[a] = {
          ...
          set: function (t, e, i) {
            var s,
              n = Pt(t),
              o = !_.scrollboxSize() && 'absolute' === n.position,
              r = (o || i) && 'border-box' === C.css(t, 'boxSizing', !1, n),
              i = i ? ne(t, a, i, r, n) : 0;
            return (
              r &&
                o &&
      ...
      (C.cssHooks.marginLeft = Ut(_.reliableMarginLeft, function (t, e) {
        if (e)
          return (
      ...
      C.each({ margin: '', padding: '', border: 'Width' }, function (n, o) {
        (C.cssHooks[n + o] = {
          expand: function (t) {
            for (
              var e = 0, i = {}, s = 'string' == typeof t ? t.split(' ') : [t];
              e < 4;
              e++
            )
              i[n + et[e] + o] = s[e] || s[e - 2] || s[0];
            return i;
          },
        }),
          'margin' !== n && (C.cssHooks[n + o].set = se);
      }),
      C.fn.extend({
        css: function (t, e) {
          return R(
            ...
            function (t, e, i) {
              var s,
                ...
                r = 0;
              if (Array.isArray(e)) {
                for (s = Pt(t), n = e.length; r < n; r++)
                  o[e[r]] = C.css(t, e[r], !1, s);
                return o;
              }
      ...
      (((C.Tween = re).prototype = {
        ...
        run: function (t) {
          ...
          return (
            ...
            (i && i.set ? i : re.propHooks._default).set(this),
            this
          );
        },
        ...
        _default: {
          ...
          set: function (t) {
            C.fx.step[t.prop]
              ? C.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!C.cssHooks[t.prop] && null == t.elem.style[Jt(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    function ge(n, t, e) {
      var i,
        ...
        l = function () {
          ...
          for (
            ...
            c.tweens[i].run(e);
          return (
            a.notifyWith(n, [c, e, t]),
            e < 1 && s
              ? t
              : (s || a.notifyWith(n, [c, 1, 0]), a.resolveWith(n, [c]), !1)
          );
        },
        c = a.promise({
          elem: n,
          ...
          stop: function (t) {
            ...
            return (
              t
                ? (a.notifyWith(n, [c, 1, 0]), a.resolveWith(n, [c, t]))
                : a.rejectWith(n, [c, t]),
              this
            );
          },
      ...
      for (
        ...
        if ((i = ge.prefilters[s].call(c, n, h, c.opts)))
          return (
            g(i.stop) &&
      ...
      return (
        C.map(h, fe, c),
        g(c.opts.start) && c.opts.start.call(n, c),
        c
          .progress(c.opts.progress)
          .done(c.opts.done, c.opts.complete)
          .fail(c.opts.fail)
          .always(c.opts.always),
        C.fx.timer(C.extend(l, { elem: n, anim: c, queue: c.opts.queue })),
        c
      );
    }
    (C.Animation = C.extend(ge, {
      ...
      tweener: function (t, e) {
        for (
          var i, s = 0, n = (t = g(t) ? ((e = t), ['*']) : t.match(N)).length;
          s < n;
          s++
        )
          (i = t[s]),
          ...
          if ((l = !C.isEmptyObject(e)) || !C.isEmptyObject(d))
            ...
            d))
              l ||
                ...
                f && lt([t], !0),
                u.done(function () {
                  for (s in (f || lt([t]), K.remove(t, 'fxshow'), d))
                    C.style(t, s, d[s]);
                })),
                (l = fe(f ? g[s] : 0, s, u)),
                s in g ||
                  ((g[s] = l.start), f && ((l.end = l.start), (l.start = 0)));
        },
      ],
      ...
      (C.speed = function (t, e, i) {
        ...
        return (
          ...
          (s.old = s.complete),
          (s.complete = function () {
            g(s.old) && s.old.call(this), s.queue && C.dequeue(this, s.queue);
          }),
          s
        );
      }),
      C.fn.extend({
        ...
        animate: function (e, t, i, s) {
          var n = C.isEmptyObject(e),
            o = C.speed(t, i, s),
            s = function () {
              var t = ge(this, C.extend({}, e), o);
              (n || K.get(this, 'finish')) && t.stop(!0);
            };
          return (
            (s.finish = s),
            n || !1 === o.queue ? this.each(s) : this.queue(o.queue, s)
          );
        },
        stop: function (n, t, o) {
          function r(t) {
          ...
          return (
            'string' != typeof n && ((o = t), (t = n), (n = void 0)),
            t && this.queue(n || 'fx', []),
            this.each(function () {
              var t = !0,
              ...
              else for (e in s) s[e] && s[e].stop && he.test(e) && r(s[e]);
              for (e = i.length; e--; )
                i[e].elem !== this ||
                  (null != n && i[e].queue !== n) ||
                  (i[e].anim.stop(o), (t = !1), i.splice(e, 1));
              (!t && o) || C.dequeue(this, n);
            })
          );
        },
        finish: function (r) {
      ...
      (dt = k.createElement('input')),
      (Z = k.createElement('select').appendChild(k.createElement('option'))),
      (dt.type = 'checkbox'),
      (_.checkOn = '' !== dt.value),
      (_.optSelected = Z.selected),
      ((dt = k.createElement('input')).value = 't'),
      (dt.type = 'radio'),
      (_.radioValue = 't' === dt.value);
    var me,
      ve = C.expr.attrHandle;
    C.fn.extend({
      attr: function (t, e) {
        return R(this, C.attr, t, e, 1 < arguments.length);
      },
    ...
    C.fn.extend({
      prop: function (t, e) {
        return R(this, C.prop, t, e, 1 < arguments.length);
      },
      ...
      C.extend({
        prop: function (t, e, i) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return (
              (1 === o && C.isXMLDoc(t)) ||
                ((e = C.propFix[e] || e), (n = C.propHooks[e])),
              void 0 !== i
                ? n && 'set' in n && void 0 !== (s = n.set(t, i, e))
                  ? s
                  : (t[e] = i)
      ...
      C.fn.extend({
        addClass: function (e) {
          ...
          if ((t = xe(e)).length)
            for (; (i = this[a++]); )
              if (((r = we(i)), (s = 1 === i.nodeType && ' ' + ye(r) + ' '))) {
                for (o = 0; (n = t[o++]); )
                  s.indexOf(' ' + n + ' ') < 0 && (s += n + ' ');
                r !== (r = ye(s)) && i.setAttribute('class', r);
              }
          return this;
        },
        ...
        toggleClass: function (n, e) {
          ...
          return 'boolean' == typeof e && r
            ...
            ? this.each(function (t) {
                C(this).toggleClass(n.call(this, t, we(this), e), e);
              })
            : this.each(function () {
                var t, e, i, s;
                if (r)
                  for (e = 0, i = C(this), s = xe(n); (t = s[e++]); )
                    i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else
                  (void 0 !== n && 'boolean' != o) ||
                    ((t = we(this)) && K.set(this, '__className__', t),
                    this.setAttribute &&
                      this.setAttribute(
                        'class',
        ...
        hasClass: function (t) {
          for (var e, i = 0, s = ' ' + t + ' '; (e = this[i++]); )
            if (1 === e.nodeType && -1 < (' ' + ye(we(e)) + ' ').indexOf(s))
              return !0;
          return !1;
        },
      });
      ...
      val: function (e) {
        ...
        return arguments.length
          ? ((s = g(e)),
            this.each(function (t) {
              1 === this.nodeType &&
                (null == (t = s ? e.call(this, t, C(this).val()) : e)
                  ? (t = '')
                  : 'number' == typeof t
                  ? (t += '')
                  : Array.isArray(t) &&
          ...
          : n
          ? (i = C.valHooks[n.type] || C.valHooks[n.nodeName.toLowerCase()]) &&
            'get' in i &&
      ...
      C.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var i, s, n = t.options, o = C.makeArray(e), r = n.length;
                r--;

              )
                ((s = n[r]).selected =
                  -1 < C.inArray(C.valHooks.option.get(s), o)) && (i = !0);
    ...
    C.extend(C.event, {
      trigger: function (t, e, i, s) {
        ...
        if (
          3 !== i.nodeType &&
          8 !== i.nodeType &&
          !Te.test(d + C.event.triggered) &&
          (-1 < d.indexOf('.') && ((d = (p = d.split('.')).shift()), p.sort()),
          (a = d.indexOf(':') < 0 && 'on' + d),
          ((t = t[C.expando]
            ? t
            : new C.Event(d, 'object' == typeof t && t)).isTrigger = s ? 2 : 3),
          (t.namespace = p.join('.')),
          ...
          (c = C.event.special[d] || {}),
          s || !c.trigger || !1 !== c.trigger.apply(i, e))
        ) {
          if (!s && !c.noBubble && !m(i)) {
            for (
              r = c.delegateType || d, Te.test(r + d) || (f = f.parentNode);
              f;
              f = f.parentNode
            )
              u.push(f), (o = f);
            o === (i.ownerDocument || k) &&
              u.push(o.defaultView || o.parentWindow || x);
          }
          for (n = 0; (f = u[n++]) && !t.isPropagationStopped(); )
            (h = f),
              (t.type = 1 < n ? r : c.bindType || d),
              (l =
                (K.get(f, 'events') || Object.create(null))[t.type] &&
          ...
          return (
            ...
            s ||
              ...
              (a &&
                ...
                ((o = i[a]) && (i[a] = null),
                (C.event.triggered = d),
                t.isPropagationStopped() && h.addEventListener(d, Ce),
                i[d](),
                t.isPropagationStopped() && h.removeEventListener(d, Ce),
      ...
      simulate: function (t, e, i) {
        t = C.extend(new C.Event(), i, { type: t, isSimulated: !0 });
      ...
      _.focusin ||
        C.each({ focus: 'focusin', blur: 'focusout' }, function (i, s) {
          function n(t) {
            C.event.simulate(s, t.target, C.event.fix(t));
          }
          C.event.special[s] = {
            setup: function () {
              var t = this.ownerDocument || this.document || this,
                e = K.access(t, s);
              e || t.addEventListener(i, n, !0), K.access(t, s, (e || 0) + 1);
            },
            teardown: function () {
              var t = this.ownerDocument || this.document || this,
                e = K.access(t, s) - 1;
              e
                ? K.access(t, s, e)
                : (t.removeEventListener(i, n, !0), K.remove(t, s));
            },
          };
        });
    var Se = x.location,
      ...
      if (Array.isArray(t) || (t.jquery && !C.isPlainObject(t)))
        ...
        for (s in t)
          !(function i(s, t, n, o) {
            ...
            else if (n || 'object' !== f(t)) o(s, t);
            else for (var e in t) i(s + '[' + e + ']', t[e], n, o);
          })(s, t[s], e, i);
      return n.join('&');
    }),
      C.fn.extend({
    ...
    (Fe.href = Se.href),
        ...
        ajax: function (t, e) {
          ...
          if (
            ...
            try {
              (n.href = f.url),
                (n.href = n.href),
                (f.crossDomain =
                  Fe.protocol + '//' + Fe.host != n.protocol + '//' + n.host);
            } catch (t) {
              f.crossDomain = !0;
            }
          }
          ...
          f.hasContent
            ? f.data &&
              ...
              (f.data = f.data.replace(Pe, '+'))
            : ((n = f.url.slice(c.length)),
              f.data &&
                (f.processData || 'string' == typeof f.data) &&
                ((c += (Ee.test(c) ? '&' : '?') + f.data), delete f.data),
              !1 === f.cache &&
                ((c = c.replace(He, '$1')),
                (n = (Ee.test(c) ? '&' : '?') + '_=' + De.guid++ + n)),
              (f.url = c + n)),
          f.ifModified &&
            (C.lastModified[c] &&
              y.setRequestHeader('If-Modified-Since', C.lastModified[c]),
            C.etag[c] && y.setRequestHeader('If-None-Match', C.etag[c])),
          ((f.data && f.hasContent && !1 !== f.contentType) || e.contentType) &&
            y.setRequestHeader('Content-Type', f.contentType),
          y.setRequestHeader(
            'Accept',
          ...
          f.headers))
            y.setRequestHeader(s, f.headers[s]);
          if (f.beforeSend && (!1 === f.beforeSend.call(g, y, f) || d))
            return y.abort();
          if (
            ((a = 'abort'),
            b.add(f.complete),
            ...
            if (((y.readyState = 1), p && m.trigger('ajaxSend', [y, f]), d))
              return y;
            f.async &&
              0 < f.timeout &&
          ...
          function w(t, e, i, s) {
            ...
            d ||
              ...
              i &&
                (r = (function (t, e, i) {
                  for (
                    var s, n, o, r, a = t.contents, l = t.dataTypes;
                    '*' === l[0];
              ...
              s
                ? (f.ifModified &&
                    ((i = y.getResponseHeader('Last-Modified')) &&
                      (C.lastModified[c] = i),
                    (i = y.getResponseHeader('etag')) && (C.etag[c] = i)),
                  204 === t || 'HEAD' === f.type
                    ? (a = 'nocontent')
                    : 304 === t
                    ? (a = 'notmodified')
                    : ((a = r.state), (n = r.data), (s = !(o = r.error))))
                : ((o = a), (!t && a) || ((a = 'error'), t < 0 && (t = 0))),
              (y.status = t),
              (y.statusText = (e || a) + ''),
              s ? v.resolveWith(g, [n, a, y]) : v.rejectWith(g, [y, a, o]),
              y.statusCode(_),
              (_ = void 0),
              p &&
                m.trigger(s ? 'ajaxSuccess' : 'ajaxError', [y, f, s ? n : o]),
              b.fireWith(g, [y, a]),
              p &&
                (m.trigger('ajaxComplete', [y, f]),
      ...
      C.each(['get', 'post'], function (t, n) {
        C[n] = function (t, e, i, s) {
          return (
            g(e) && ((s = s || i), (i = e), (e = void 0)),
            C.ajax(
              C.extend(
                { url: t, type: n, dataType: s, data: e, success: i },
                C.isPlainObject(t) && t
              )
            )
          );
    ...
    (_.cors = !!Ve && 'withCredentials' in Ve),
      (_.ajax = Ve = !!Ve),
      C.ajaxTransport(function (n) {
        var o, r;
        if (_.cors || (Ve && !n.crossDomain))
          return {
            send: function (t, e) {
              var i,
                s = n.xhr();
              ...
              (o = function (t) {
                ...
                (s.onload = o()),
                (r = s.onerror = s.ontimeout = o('error')),
                void 0 !== s.onabort
                  ? (s.onabort = r)
    ...
    C.ajaxSetup({
      ...
      jsonpCallback: function () {
        var t = Ke.pop() || C.expando + '_' + De.guid++;
        return (this[t] = !0), t;
      },
    }),
      C.ajaxPrefilter('json jsonp', function (t, e, i) {
        ...
        if (r || 'jsonp' === t.dataTypes[0])
          return (
            ...
            r
              ? (t[r] = t[r].replace(Xe, '$1' + s))
              : !1 !== t.jsonp &&
                (t.url += (Ee.test(t.url) ? '&' : '?') + t.jsonp + '=' + s),
            ...
            i.always(function () {
              void 0 === n ? C(x).removeProp(s) : (x[s] = n),
                t[s] && ((t.jsonpCallback = e.jsonpCallback), Ke.push(s)),
                o && g(n) && n(o[0]),
                (o = n = void 0);
            }),
            'script'
      ...
      (_.createHTMLDocument =
        (((dt = k.implementation.createHTMLDocument('').body).innerHTML =
          '<form></form><form></form>'),
      ...
      (C.fn.load = function (t, e, i) {
        var s,
          ...
          a = t.indexOf(' ');
        return (
          -1 < a && ((s = ye(t.slice(a))), (t = t.slice(0, a))),
          g(e)
            ? ((i = e), (e = void 0))
            : e && 'object' == typeof e && (n = 'POST'),
          0 < r.length &&
            C.ajax({ url: t, type: n || 'GET', dataType: 'html', data: e })
              .done(function (t) {
                (o = arguments),
                  r.html(s ? C('<div>').append(C.parseHTML(t)).find(s) : t);
              })
              .always(
                i &&
                  function (t, e) {
          ...
          'static' === a && (t.style.position = 'relative'),
            ...
            (r =
              ...
              -1 < (s + r).indexOf('auto')
                ...
                : ((n = parseFloat(s) || 0), parseFloat(r) || 0)),
            null != (e = g(e) ? e.call(t, i, C.extend({}, o)) : e).top &&
              (c.top = e.top - o.top + n),
            null != e.left && (c.left = e.left - o.left + r),
          ...
          if (this[0]) {
            ...
            if ('fixed' === C.css(s, 'position')) e = s.getBoundingClientRect();
              ...
              t &&
                t !== s &&
                1 === t.nodeType &&
                (((n = C(t).offset()).top += C.css(t, 'borderTopWidth', !0)),
                (n.left += C.css(t, 'borderLeftWidth', !0)));
            }
            return {
              top: e.top - n.top - C.css(s, 'marginTop', !0),
              left: e.left - n.left - C.css(s, 'marginLeft', !0),
            };
          }
        },
      ...
      C.each(['top', 'left'], function (t, i) {
        C.cssHooks[i] = Ut(_.pixelPosition, function (t, e) {
          if (e)
            return (e = Yt(t, i)), Bt.test(e) ? C(t).position()[i] + 'px' : e;
        });
      }),
    ...
    (C.proxy = function (t, e) {
      var i, s;
      if (('string' == typeof e && ((s = t[e]), (e = t), (t = s)), g(t)))
        return (
    ...
    return (
      (C.noConflict = function (t) {
        return (
          x.$ === C && (x.$ = Je), t && x.jQuery === C && (x.jQuery = Ge), C
        );
      }),
      void 0 === t && (x.jQuery = x.$ = C),
      C
    );
  }),
  ...
  (function (e) {
    ...
    (a.migrateVersion = '3.3.2'),
      s.console &&
        s.console.log &&
        ((a && t('3.0.0')) ||
          s.console.log('JQMIGRATE: jQuery 3.0.0+ REQUIRED'),
        a.migrateWarnings &&
          s.console.log('JQMIGRATE: Migrate plugin loaded multiple times'),
        s.console.log(
    ...
    function l(t) {
      var e = s.console;
      (a.migrateDeduplicateWarnings && i[t]) ||
        ((i[t] = !0),
    ...
    function n(t, e, i, s) {
      t[e] = function () {
        return l(s), i.apply(this, arguments);
      };
    }
    (a.migrateDeduplicateWarnings = !0),
      ...
      'BackCompat' === s.document.compatMode &&
    ...
    (a.find = function (e) {
      ...
      if ('string' == typeof e && p.test(e))
        try {
          ...
          e = e.replace(f, function (t, e, i, s) {
            return '[' + e + i + '"' + s + '"]';
          });
          try {
            s.document.querySelector(e),
    ...
    n(
      ...
      n(a, 'holdReady', a.holdReady, 'jQuery.holdReady is deprecated'),
      n(
        a,
        'unique',
        a.uniqueSort,
        ...
        n(
          ...
          function (t) {
            return null == t
              ? t + ''
              : 'object' == typeof t || 'function' == typeof t
              ? h[Object.prototype.toString.call(t)] || 'object'
              : typeof t;
          },
        ...
        (a.ajax = function () {
          ...
          return (
            t.promise &&
              ...
              n(t, 'error', t.fail, 'jQXHR.error is deprecated and removed'),
              n(
                t,
                'complete',
                t.always,
    ...
    a.swap &&
      ...
      (a.swap = function (t, e, i, s) {
        var n,
          o = {};
        for (n in (w || l('jQuery.swap() is undocumented and deprecated'), e))
      ...
      (a.fn.css = function (t, e) {
        ...
        return t && 'object' == typeof t && !Array.isArray(t)
          ...
          : ('number' == typeof e &&
              ((i = _(t)),
              (x.test((e = i)) && k.test(e[0].toUpperCase() + e.slice(1))) ||
                a.cssNumber[i] ||
                l(
    ...
    (a.data = function (t, e, i) {
      ...
      if (e && 'object' == typeof e && 2 === arguments.length) {
        for (o in ((s = a.hasData(t) && E.call(this, t)), (n = {}), e))
          o !== _(o)
            ? (l('jQuery.data() always sets/gets camelCased names: ' + o),
              (s[o] = e[o]))
            : (n[o] = e[o]);
        return E.call(this, t, n), e;
      }
      return e &&
        'string' == typeof e &&
        e !== _(e) &&
        (s = a.hasData(t) && E.call(this, t)) &&
        e in s
        ? (l('jQuery.data() always sets/gets camelCased names: ' + e),
          2 < arguments.length && (s[e] = i),
          s[e])
        : E.apply(this, arguments);
    }),
      a.fx &&
        ((S = a.Tween.prototype.run),
        (D = function (t) {
          return t;
        }),
        ...
        s.requestAnimationFrame &&
          Object.defineProperty(a.fx, 'interval', {
            ...
            enumerable: !0,
            get: function () {
              return s.document.hidden || l(T), C;
            },
            set: function (t) {
              l(T), (C = t);
            },
    ...
    var A = a.fn.load,
      ...
      O = a.event.fix;
    function M(t) {
      var e = s.document.implementation.createHTMLDocument('');
    ...
    function P(t) {
      ...
      e !== t &&
        M(t) !== M(e) &&
        l('HTML tags must be properly nested and closed: ' + t);
    }
    (a.event.props = []),
      (a.event.fixHooks = {}),
      e(
      ...
      (a.event.fix = function (t) {
        ...
        if (
          ...
          !i._migrated_ &&
          ((i._migrated_ = !0),
          l('jQuery.event.fixHooks are deprecated and removed: ' + e),
          (s = i.props) && s.length)
        )
      ...
      a.each(
        ...
        function (t, i) {
          a.fn[i] = function (t, e) {
            return (
              l('jQuery.fn.' + i + '() event shorthand is deprecated'),
      ...
      a(function () {
        a(s.document).triggerHandler('ready');
      }),
      (a.event.special.ready = {
        setup: function () {
          this === s.document && l("'ready' event is deprecated");
        },
      }),
      a.fn.extend({
        bind: function (t, e, i) {
        ...
        delegate: function (t, e, i, s) {
          return l('jQuery.fn.delegate() is deprecated'), this.on(e, t, i, s);
        },
        undelegate: function (t, e, i) {
          return (
    ...
    (a.fn.offset = function () {
      var t = this[0];
      return !t || (t.nodeType && t.getBoundingClientRect)
    ...
    return (
      ...
      a.Deferred &&
                  ...
                  a
                    .Deferred(function (s) {
                      a.each(W, function (t, e) {
                        var i = 'function' == typeof n[t] && n[t];
                        o[e[1]](function () {
                          var t = i && i.apply(this, arguments);
                          t && 'function' == typeof t.promise
                            ? t
                                .promise()
                                .done(s.resolve)
                                .fail(s.reject)
        ...
        (a.Deferred.exceptionHook = j.exceptionHook)),
      a
    );
  }),
  (function (t, d, h, p) {
    ...
    function o(t) {
      var e,
        i = y.className,
        s = b._config.classPrefix || '';
      w && (i = i.baseVal),
        b._config.enableJSClass &&
          ((e = new RegExp('(^|\\s)' + s + 'no-js(\\s|$)')),
          (i = i.replace(e, '$1' + s + 'js$2'))),
        b._config.enableClasses &&
          (0 < t.length && (i += ' ' + s + t.join(' ' + s)),
          w ? (y.className.baseVal = i) : (y.className = i));
    }
    function r(t, e) {
      if ('object' == typeof t) for (var i in t) k(t, i) && r(i, t[i]);
      else {
        var s = (t = t.toLowerCase()).split('.'),
          n = b[s[0]];
        if (void 0 !== (n = 2 === s.length ? n[s[1]] : n)) return b;
    ...
    function g(t, e, i, s) {
      var n,
        ...
        a = 'modernizr',
        l = f('div'),
        c = ((r = h.body) || ((r = f(w ? 'svg' : 'body')).fake = !0), r);
      if (parseInt(i, 10))
        for (; i--; )
          ((n = f('div')).id = s ? s[i] : a + (i + 1)), l.appendChild(n);
      return (
        ((r = f('style')).type = 'text/css'),
        (r.id = 's' + a),
    ...
    function m(t, e, i) {
      ...
      return (
        'getComputedStyle' in d
          ...
          : (s = !e && t.currentStyle && t.currentStyle[i]),
        s
      );
    }
    function v(t) {
    ...
    function l(t, e, i, s) {
      ...
      for (
        var r, a, l, c, h, u = ['modernizr', 'tspan', 'samp'];
        !O.style && u.length;

      )
        (r = !0), (O.modElem = f(u.shift())), (O.style = O.modElem.style);
      for (l = t.length, a = 0; a < l; a++)
        if (
          ...
          if (s || void 0 === i) return n(), 'pfx' !== e || c;
          try {
            O.style[c] = i;
          } catch (t) {}
          if (O.style[c] !== h) return n(), 'pfx' !== e || c;
        }
      return n(), !1;
    }
    function c(t, e, i) {
    ...
    function s(t, e, i, s, n) {
      var o = t.charAt(0).toUpperCase() + t.slice(1),
        r = (t + ' ' + A.join(o + ' ') + o).split(' ');
      return a(e, 'string') || void 0 === e
        ? l(r, e, s, n)
        : c((r = (t + ' ' + x.join(o + ' ') + o).split(' ')), e, i);
    }
    function n(t, e, i) {
      return s(t, p, p, e, i);
    }
    ...
    var b = new b(),
      ...
      i = 'Moz O ms Webkit',
      x = e._config.usePrefixes ? i.toLowerCase().split(' ') : [];
    e._domPrefixes = x;
    var k,
      C,
    ...
    e.hasEvent = D;
    var E,
      T = (E = d.matchMedia || d.msMatchMedia)
        ? function (t) {
            t = E(t);
    ...
    var A = e._config.usePrefixes ? i.split(' ') : [];
    e._cssomPrefixes = A;
    var I = { elem: f('modernizr') };
    b._q.push(function () {
      delete I.elem;
    });
    var O = { style: I.elem.style };
    b._q.unshift(function () {
      delete O.style;
    }),
      (e.testAllProps = s),
      (e.testAllProps = n),
      (e.testProp = function (t, e, i) {
        return l([t], p, e, i);
      }),
      (e.testStyles = g),
      b.addTest('customelements', 'customElements' in d),
    ...
    b.addTest('postmessage', new Boolean('postMessage' in d)),
      b.addTest('postmessage.structuredclones', P),
      b.addTest('webgl', function () {
        return 'WebGLRenderingContext' in d;
      });
    i = !1;
    try {
      i = 'WebSocket' in d && 2 === d.WebSocket.CLOSING;
    } catch (t) {}
    b.addTest('websockets', i),
      b.addTest('cssanimations', n('animationName', 'a', !0)),
      (function () {
      ...
      b.addTest('flexbox', n('flexBasis', '1px', !0)),
      b.addTest('picture', 'HTMLPictureElement' in d),
      ...
      b.addTest('srcset', 'srcset' in f('img')),
      b.addTest('webworkers', 'Worker' in d),
      (function () {
        var t, e, i, s, n, o, r;
        for (r in u)
          if (u.hasOwnProperty(r)) {
            ...
            for (
              s = a(e.fn, 'function') ? e.fn() : e.fn, n = 0;
              n < t.length;
              n++
            )
              1 === (o = t[n].split('.')).length
                ? (b[o[0]] = s)
                : ((b[o[0]] && (!b[o[0]] || b[o[0]] instanceof Boolean)) ||
                    (b[o[0]] = new Boolean(b[o[0]])),
                  (b[o[0]][o[1]] = s)),
                _.push((s ? '' : 'no-') + o.join('-'));
          }
      })(),
  ...
  function () {
    ...
    (s.prototype.hasNext = function () {
      ...
      (s.prototype.run = function (t) {
        ...
        return (
          ...
          'undefined' != typeof document &&
            ...
            (window[e] = new s(this.options, this)),
      ...
      (s.prototype.parse = function (t) {
        ...
        if (
          ...
          if (
            ...
            null != this.options.limit && d.length > C && (d = d.slice(0, C)),
            ...
            for (
              a = '', T = document.createElement('div'), l = 0, _ = d.length;
              l < _;
              l++
            ) {
              if (
                'object' !=
                typeof (h = (c = d[l]).images[this.options.resolution])
              )
                throw (
                  ((o =
            ...
            for (
              T.innerHTML = a, n = [], s = 0, i = T.childNodes.length;
              s < i;

            )
              n.push(T.childNodes[s]), (s += 1);
            for (v = 0, y = n.length; v < y; v++) (x = n[v]), r.appendChild(x);
          } else
            for (b = 0, w = d.length; b < w; b++) {
              if (
                ((c = d[b]),
                (p = document.createElement('img')),
                'object' != typeof (h = c.images[this.options.resolution]))
              )
                throw (
                  ((o =
                    'No image found for resolution: ' +
          ...
          if (
            null ==
            (C =
              'string' == typeof (C = this.options.target)
      ...
      (s.prototype._makeTemplate = function (t, e) {
        for (
          var i, s, n = /(?:\{{2})([\w\[\]\.]+)(?:\}{2})/, o = t;
          n.test(o);
          ...
          (i = o.match(n)[1]),
            (s = null != (i = this._getObjectProperty(e, i)) ? i : ''),
            (o = o.replace(n, function () {
              return '' + s;
            }));
        return o;
      }),
      (s.prototype._getObjectProperty = function (t, e) {
        for (
          var i, s = (e = e.replace(/\[(\w+)\]/g, '.$1')).split('.');
          s.length;
      ...
      (s.prototype._sortBy = function (t, i, s) {
        var e = function (t, e) {
          (t = this._getObjectProperty(t, i)),
            (e = this._getObjectProperty(e, i));
          return s ? (e < t ? 1 : -1) : t < e ? 1 : -1;
        };
  ...
  (function (t) {
    ...
    function z(s) {
      ...
      return (
        ...
        D(y, function (t, e) {
          ...
          return i
            ? ((i = n[e](i)),
              (n[k[e].cache] = i[k[e].cache]),
              (o = n._rgba = i._rgba),
              !1)
            : v;
        }),
        o.length
          ? ('0,0,0,0' === o.join() && m.extend(o, b.transparent), n)
          : b[s]
      );
    }
    function j(t, e, i) {
    ...
    (x.effects = { effect: {} }),
      ...
      (T.rgba = -1 < S.style.backgroundColor.indexOf('rgba')),
      D(k, function (t, e) {
        (e.cache = '_' + t),
          (e.props.alpha = { idx: 3, type: 'percent', def: 1 });
      }),
      ((w.fn = m.extend(w.prototype, {
        parse: function (n, t, e, i) {
          if (n === v) return (this._rgba = [null, null, null, null]), this;
          (n.jquery || n.nodeType) && ((n = m(n).css(t)), (t = v));
          var o = this,
            s = m.type(n),
            r = (this._rgba = []);
          return (
            t !== v && ((n = [n, t, e, i]), (s = 'array')),
            'string' === s
              ? this.parse(z(n) || b._default)
              : 'array' === s
              ? (D(k.rgba.props, function (t, e) {
                  r[e.idx] = L(n[e.idx], e);
                }),
                this)
              : 'object' === s
            ...
            D(k, function (t, e) {
              ...
              return (
                s &&
                  ...
                  D(e.props, function (t, e) {
                    return null != s[e.idx] ? (o = s[e.idx] === i[e.idx]) : v;
                  })),
                o
              );
            }),
      ...
      (k.hsla.from = function (t) {
        ...
        var e = t[0] / 360,
          ...
          s = 2 * s - i;
        return [
          Math.round(255 * j(s, i, e + 1 / 3)),
          Math.round(255 * j(s, i, e)),
          Math.round(255 * j(s, i, e - 1 / 3)),
          t,
        ];
      }),
      D(k, function (a, t) {
        var o = t.props,
          ...
          c = t.from;
        (w.fn[a] = function (t) {
          if ((l && !this[r] && (this[r] = l(this._rgba)), t === v))
            return this[r].slice();
          var e,
            i = m.type(t),
          ...
          return (
            D(o, function (t, e) {
              ...
              null == t && (t = n[e.idx]), (n[e.idx] = L(t, e));
            }),
            c ? (((e = w(c(n)))[r] = n), e) : w(n)
          );
        }),
      ...
      (m.cssHooks.borderColor = {
        expand: function (i) {
          var s = {};
          return (
            D(['Top', 'Right', 'Bottom', 'Left'], function (t, e) {
              s['border' + e + 'Color'] = i;
            }),
            s
          );
      ...
      x.expr &&
        ...
        (x.expr.filters.animated =
          ((h = x.expr.filters.animated),
          function (t) {
            return !!x(t).data(I) || h(t);
          })),
      !1 !== x.uiBackCompat &&
        x.extend(x.effects, {
          save: function (t, e) {
          ...
          restore: function (t, e) {
            for (var i, s = 0, n = e.length; s < n; s++)
              null !== e[s] && ((i = t.data(E + e[s])), t.css(e[s], i));
          },
      ...
      x.fn.extend({
        ...
        show:
          ((c = x.fn.show),
          function (t) {
            if (P(t)) return c.apply(this, arguments);
        ...
        hide:
          ((a = x.fn.hide),
          function (t) {
            if (P(t)) return a.apply(this, arguments);
            var e = M.apply(this, arguments);
        ...
        toggle:
          ((r = x.fn.toggle),
          function (t) {
            if (P(t) || 'boolean' == typeof t) return r.apply(this, arguments);
            var e = M.apply(this, arguments);
    ...
    var W, $, R, F, B, q, Y, U, V, K, X;
    x.effects;
    function Q(t, e, i) {
      return [
        parseFloat(t[0]) * (V.test(t[0]) ? e / 100 : 1),
        parseFloat(t[1]) * (V.test(t[1]) ? i / 100 : 1),
      ];
    }
    function G(t, e) {
    ...
    x.effects.define('blind', 'hide', function (t, e) {
      ...
      (r.clip[i[n][0]] = r.clip[i[n][1]]),
        'show' === t.mode &&
          (s.cssClip(r.clip), a && a.css(x.effects.clipToBox(r)), (r.clip = o)),
      ...
      x.effects.define('bounce', function (t, e) {
        ...
        for (
          x.effects.createPlaceholder(n),
            l = n.css(p),
            c = c || n['top' == p ? 'outerHeight' : 'outerWidth']() / 3,
            a &&
              (((s = { opacity: 1 })[p] = l),
              n
                .css('opacity', 0)
      ...
      x.effects.define('explode', 'hide', function (t, e) {
        function i() {
          g.push(this),
            g.length === l * c &&
              (h.css({ visibility: 'visible' }), x(g).remove(), e());
        }
        for (
          var s,
            n,
            ...
            f = Math.ceil(h.outerHeight() / l),
            g = [],
            m = 0;
          m < l;
          m++
        )
          for (o = d.top + m * f, a = m - (l - 1) / 2, s = 0; s < c; s++)
            (n = d.left + s * p),
              (r = s - (c - 1) / 2),
              h
                .clone()
      ...
      x.effects.define('fold', 'hide', function (e, t) {
        ...
        a && (r = (parseInt(a[1], 10) / 100) * f[o ? 0 : 1]),
          ...
          n &&
            (i.cssClip(p.clip),
            h && h.css(x.effects.clipToBox(p)),
            (p.clip = u)),
          i
            .queue(function (t) {
              h &&
                h
                  .animate(x.effects.clipToBox(d), c, e.easing)
                  .animate(x.effects.clipToBox(p), c, e.easing),
                t();
            })
      ...
      x.effects.define('size', function (s, e) {
        ...
        x.effects.createPlaceholder(i),
          ...
          ('box' !== c && 'both' !== c) ||
            (n.from.y !== n.to.y &&
              ((f = x.effects.setTransition(i, o, n.from.y, f)),
              (g = x.effects.setTransition(i, o, n.to.y, g))),
            n.from.x !== n.to.x &&
              ((f = x.effects.setTransition(i, r, n.from.x, f)),
              (g = x.effects.setTransition(i, r, n.to.x, g)))),
          ('content' !== c && 'both' !== c) ||
            n.from.y === n.to.y ||
            ((f = x.effects.setTransition(i, t, n.from.y, f)),
            (g = x.effects.setTransition(i, t, n.to.y, g))),
          h &&
            ((h = x.effects.getBaseline(h, p)),
            (f.top = (p.outerHeight - f.outerHeight) * h.y + d.top),
            (f.left = (p.outerWidth - f.outerWidth) * h.x + d.left),
            (g.top = (p.outerHeight - g.outerHeight) * h.y + d.top),
            (g.left = (p.outerWidth - g.outerWidth) * h.x + d.left)),
          i.css(f),
          ('content' !== c && 'both' !== c) ||
            ...
            i.find('*[width]').each(function () {
              ...
              n.from.y !== n.to.y &&
                ((i = x.effects.setTransition(t, o, n.from.y, i)),
                (e = x.effects.setTransition(t, o, n.to.y, e))),
                n.from.x !== n.to.x &&
                  ((i = x.effects.setTransition(t, r, n.from.x, i)),
                  (e = x.effects.setTransition(t, r, n.to.x, e))),
      ...
      x.effects.define('pulsate', 'show', function (t, e) {
        var i = x(this),
          ...
          s = i.queue().length;
        for (
          (!n && i.is(':visible')) || (i.css('opacity', 0).show(), (a = 1));
          l < o;
          l++
        )
        ...
        return (
          ...
          x.each(['my', 'at'], function () {
            ...
            ((i =
              ...
              (i[1] = q.test(i[1]) ? i[1] : 'center'),
              (t = Y.exec(i[0])),
              (e = Y.exec(i[1])),
              (w[this] = [t ? t[0] : 0, e ? e[0] : 0]),
              (u[this] = [U.exec(i[0])[0], U.exec(i[1])[0]]);
          }),
          1 === y.length && (y[1] = y[0]),
          'right' === u.at[0]
            ? (m.left += p)
          ...
          this.each(function () {
            var i,
              ...
              e = G(this, 'marginLeft'),
              s = G(this, 'marginTop'),
              n = a + e + G(this, 'marginRight') + _.width,
              o = l + s + G(this, 'marginBottom') + _.height,
              c = x.extend({}, m),
              h = Q(w.my, r.outerWidth(), r.outerHeight());
            'right' === u.my[0]
              ? (c.left -= a)
              : 'center' === u.my[0] && (c.left -= a / 2),
              'bottom' === u.my[1]
                ? (c.top -= l)
                : 'center' === u.my[1] && (c.top -= l / 2),
              (c.left += h[0]),
              (c.top += h[1]),
              (i = { marginLeft: e, marginTop: s }),
              x.each(['left', 'top'], function (t, e) {
                x.ui.position[y[t]] &&
                  x.ui.position[y[t]][e](c, {
                    targetWidth: p,
                    targetHeight: f,
                    elemWidth: a,
                    elemHeight: l,
              ...
              u.using &&
                (t = function (t) {
                  ...
                  p < a && p > F(e + i) && (o.horizontal = 'center'),
                    f < l && f > F(s + n) && (o.vertical = 'middle'),
                    (o.important =
                      R(F(e), F(i)) > R(F(s), F(n))
                        ? 'horizontal'
                        : 'vertical'),
      ...
      (x.ui.position = {
        fit: {
          left: function (t, e) {
            ...
            e.collisionWidth > n
              ? 0 < r && a <= 0
                ? ((i = t.left + r + e.collisionWidth - n - s),
                  (t.left += r - i))
                : (t.left =
                    !(0 < a && r <= 0) && a < r ? s + n - e.collisionWidth : s)
              : 0 < r
              ? (t.left += r)
              : 0 < a
              ? (t.left -= a)
          ...
          top: function (t, e) {
            ...
            e.collisionHeight > n
              ? 0 < r && a <= 0
                ? ((i = t.top + r + e.collisionHeight - n - s),
                  (t.top += r - i))
                : (t.top =
                    !(0 < a && r <= 0) && a < r ? s + n - e.collisionHeight : s)
              : 0 < r
              ? (t.top += r)
              : 0 < a
              ? (t.top -= a)
        ...
        flip: {
          left: function (t, e) {
            var i = e.within,
              ...
              r = -2 * e.offset[0];
            a < 0
              ? ((s = t.left + c + i + r + e.collisionWidth - n - s) < 0 ||
                  F(a) > s) &&
                (t.left += c + i + r)
              : 0 < l &&
                (0 <
                  (o =
                    t.left - e.collisionPosition.marginLeft + c + i + r - o) ||
                  l > F(o)) &&
                (t.left += c + i + r);
          },
          top: function (t, e) {
            var i = e.within,
              ...
              r = -2 * e.offset[1];
            a < 0
              ? ((s = t.top + c + i + r + e.collisionHeight - n - s) < 0 ||
                  F(a) > s) &&
                (t.top += c + i + r)
              : 0 < l &&
                (0 <
                  (o = t.top - e.collisionPosition.marginTop + c + i + r - o) ||
                  l > F(o)) &&
                (t.top += c + i + r);
          },
        },
    ...
    (x.cleanData =
      ...
      (x.widget = function (t, i, e) {
        ...
        return (
          ...
          (n.prototype = x.widget.extend(
            ...
            r,
            { constructor: n, namespace: a, widgetName: t, widgetFullName: l }
          )),
          s
      ...
      (x.widget.extend = function (t) {
        for (
          var e, i, s = tt.call(arguments, 1), n = 0, o = s.length;
          n < o;
          n++
        )
          for (e in s[n])
      ...
      (x.Widget.prototype = {
        ...
        _classes: function (n) {
          function t(t, e) {
            for (var i, s = 0; t.length > s; s++)
              (i = r.classesElementLookup[t[s]] || x()),
                (i = n.add
        ...
        _on: function (n, o, t) {
          ...
          'boolean' != typeof n && ((t = o), (o = n), (n = !1)),
            t
              ? ((o = r = x(o)), (this.bindings = this.bindings.add(o)))
            ...
            x.each(t, function (t, e) {
              function i() {
                return n ||
                  ...
                  ? ('string' == typeof e ? a[e] : e).apply(a, arguments)
                  : void 0;
              }
              'string' != typeof e &&
              ...
              ? ((s = t.show().outerHeight()),
                ...
                void t.hide().animate(this.showProps, {
                  ...
                  step: function (t, e) {
                    (e.now = Math.round(t)),
                      'height' !== e.prop
                        ? 'content-box' === r && (o += e.now)
                        : 'content' !== n.options.heightStyle &&
                          ((e.now = Math.round(s - i.outerHeight() - o)),
                          (o = 0));
                  },
                }))
              : i.animate(this.hideProps, u, h, a)
            : t.animate(this.showProps, u, h, a);
        },
    ...
    x.widget('ui.controlgroup', {
      ...
      x.extend(t.prototype, {
        ...
        _dialogDatepicker: function (t, e, i, s, n) {
          ...
          return (
            r ||
              ...
              x.data(this._dialogInput[0], 'datepicker', r)),
            l(r.settings, s || {}),
        ...
        _doKeyPress: function (t) {
          ...
          return x.datepicker._get(i, 'constrainInput')
        ...
        _showDatepicker: function (t) {
          ...
          'input' !== (t = t.target || t).nodeName.toLowerCase() &&
            ...
            x.datepicker._isDisabledDatepicker(t) ||
              ...
              !1 !==
                (i = (s = x.datepicker._get(n, 'beforeShow'))
                  ? s.apply(t, [t, n])
                  : {}) &&
                (l(n.settings, i),
                (n.lastVal = null),
                ...
                (s = { left: x.datepicker._pos[0], top: x.datepicker._pos[1] }),
                ...
                (s = x.datepicker._checkOffset(n, s, e)),
                n.dpDiv.css({
                  position:
          ...
          !s ||
            ...
            (this._datepickerShowing &&
              ...
              x.effects && (x.effects.effect[e] || x.effects[e])
                ? s.dpDiv.hide(e, x.datepicker._get(s, 'showOptions'), i, t)
                : s.dpDiv[
                    'slideDown' === e
                      ? 'slideUp'
                      : 'fadeIn' === e
          ...
          function s(t, e, i) {
            ...
            if (
              (x.each(e, function (t, e) {
                var i = e[1];
                return n.substr(c, i.length).toLowerCase() === i.toLowerCase()
                  ? ((s = e[0]), (c += i.length), !1)
                  : void 0;
              }),
              -1 !== s)
                      ...
                      switch (r[2] || 'd') {
                        ...
                        case 'M':
                          (s += parseInt(r[1], 10)),
                            (n = Math.min(
                              n,
                              x.datepicker._getDaysInMonth(i, s)
                            ));
                          break;
                        case 'y':
                        case 'Y':
        ...
        _generateHTML: function (t) {
          ...
          if ((Y < 0 && ((Y += 12), U--), q))
            for (
              e = this._daylightSavingAdjust(
                new Date(
                  q.getFullYear(),
                  q.getMonth() - W[0] * W[1] + 1,
                  q.getDate()
                )
              ),
                e = B && e < B ? B : e;
              this._daylightSavingAdjust(new Date(U, Y, 1)) > e;
          ...
          for (
            t.drawMonth = Y,
              t.drawYear = U,
              $ = this._get(t, 'prevText'),
              $ = j
                ? this.formatDate(
                    $,
                    this._daylightSavingAdjust(new Date(U, Y - P, 1)),
                    this._getFormatConfig(t)
                  )
                : $,
              i = this._canAdjustMonth(t, -1, U, Y)
              ...
              $ = j
                ...
                : $,
              s = this._canAdjustMonth(t, 1, U, Y)
              ...
              $ = this._get(t, 'gotoCurrent') && t.currentDay ? F : N,
              z = j ? this.formatDate(z, $, this._getFormatConfig(t)) : z,
              j = t.inline
                ? ''
            ...
            for (v = '', this.maxRows = 4, b = 0; W[1] > b; b++) {
              if (
                ((_ = this._daylightSavingAdjust(
                  new Date(U, Y, t.selectedDay)
                )),
                (y = ' ui-corner-all'),
                (w = ''),
                R)
              ) {
                if (((w += "<div class='ui-datepicker-group"), 1 < W[1]))
                  switch (b) {
                    case 0:
                      (w += ' ui-datepicker-group-first'),
                        (y = ' ui-corner-' + (H ? 'right' : 'left'));
                      break;
                    case W[1] - 1:
                      (w += ' ui-datepicker-group-last'),
                        (y = ' ui-corner-' + (H ? 'left' : 'right'));
                      break;
                    default:
              ...
              for (
                w +=
                  ...
                  y +
                  "'>" +
                  (/all|left/.test(y) && 0 === m ? (H ? s : i) : '') +
                  (/all|right/.test(y) && 0 === m ? (H ? i : s) : '') +
              ...
              for (
                w += x + '</tr></thead><tbody>',
                  T = this._getDaysInMonth(U, Y),
                  U === t.selectedYear &&
                    Y === t.selectedMonth &&
                    (t.selectedDay = Math.min(t.selectedDay, T)),
                  C = (this._getFirstDayOfMonth(U, Y) - n + 7) % 7,
                  T = Math.ceil((C + T) / 7),
                  S = R && this.maxRows > T ? this.maxRows : T,
                  this.maxRows = S,
                  D = this._daylightSavingAdjust(new Date(U, Y, 1 - C)),
                  E = 0;
                E < S;
                E++
              ) {
                for (
                  ...
                  (I = h
                    ? h.apply(t.input ? t.input[0] : null, [D])
                    : [!0, '']),
                    (M =
                      ((O = D.getMonth() !== Y) && !d) ||
                      !I[0] ||
      ...
      x.widget('ui.draggable', x.ui.mouse, {
        ...
        _adjustOffsetFromHelper: function (t) {
          'string' == typeof t && (t = t.split(' ')),
            'left' in
              (t = x.isArray(t) ? { left: +t[0], top: +t[1] || 0 } : t) &&
              ...
              (s.axis && 'y' === s.axis) ||
                ...
                s.scrollSensitivity
                  ...
                  : t.pageX - i.overflowOffset.left < s.scrollSensitivity &&
                    (o.scrollLeft = n = o.scrollLeft - s.scrollSpeed)))
            : ((s.axis && 'x' === s.axis) ||
                (t.pageY - x(r).scrollTop() < s.scrollSensitivity
                  ? (n = x(r).scrollTop(x(r).scrollTop() - s.scrollSpeed))
                  : x(window).height() - (t.pageY - x(r).scrollTop()) <
                      s.scrollSensitivity &&
                    (n = x(r).scrollTop(x(r).scrollTop() + s.scrollSpeed))),
              (s.axis && 'y' === s.axis) ||
                (t.pageX - x(r).scrollLeft() < s.scrollSensitivity
                  ? (n = x(r).scrollLeft(x(r).scrollLeft() - s.scrollSpeed))
        ...
        drag: function (t, e, i) {
          for (
            var s,
              ...
              m = e.offset.top,
              v = m + i.helperProportions.height,
              b = i.snapElements.length - 1;
            0 <= b;
            b--
          )
            (l =
              (a = i.snapElements[b].left - i.margins.left) +
              i.snapElements[b].width),
              (h =
                (c = i.snapElements[b].top - i.margins.top) +
                i.snapElements[b].height),
              g < a - p ||
              l + p < f ||
              v < c - p ||
              h + p < m ||
              !x.contains(
                i.snapElements[b].item.ownerDocument,
                i.snapElements[b].item
              )
                ? (i.snapElements[b].snapping &&
                ...
                : ('inner' !== d.snapMode &&
                  ...
                  (i.snapElements[b].snapping = s || n || o || r || u));
        },
      }),
      ...
      x.widget('ui.resizable', x.ui.mouse, {
        ...
        _mouseCapture: function (t) {
          ...
          for (e in this.handles)
            (i = x(this.handles[e])[0]),
              (i !== t.target && !x.contains(i, t.target)) || (s = !0);
        ...
        _updateVirtualBoundaries: function (t) {
          ...
          (this._aspectRatio || t) &&
            ...
            n.maxWidth > s && (n.maxWidth = s),
            n.maxHeight > t && (n.maxHeight = t)),
            (this._vBoundaries = n);
        },
      ...
      x.ui.plugin.add('resizable', 'containment', {
        ...
        resize: function (t) {
          ...
          a[0] !== document && /static/.test(a.css('position')) && (r = s),
            ...
            (n = Math.abs(
              e.sizeDiff.width +
                (e._helper ? e.offset.left - r.left : e.offset.left - s.left)
            )),
            (s = Math.abs(
              e.sizeDiff.height +
                (e._helper ? e.offset.top - r.top : e.offset.top - s.top)
            )),
          ...
          (i.grid = a),
            ...
            /^(se|s|e)$/.test(r)
              ...
              : ((p - c <= 0 || d - l <= 0) &&
                ...
                0 < d - l
                  ? ((e.size.width = d), (e.position.left = o.left - h))
                  : ((d = l - t.width),
                    (e.size.width = d),
    ...
    var ot,
      rt = (x.ui.intersect = function (t, e, i, s) {
        ...
        switch (i) {
          ...
          case 'intersect':
            return (
              ...
              h > r - t.helperProportions.width / 2 &&
              o + t.helperProportions.height / 2 > c &&
              u > a - t.helperProportions.height / 2
            );
          case 'pointer':
            return (
              at(s.pageY, c, e.proportions().height) &&
              at(s.pageX, l, e.proportions().width)
            );
          case 'touch':
            return (
              ((c <= o && o <= u) || (c <= a && a <= u) || (o < c && u < a)) &&
        ...
        n.options.refreshPositions && x.ui.ddmanager.prepareOffsets(n, o),
          x.each(x.ui.ddmanager.droppables[n.options.scope] || [], function () {
            ...
            this.options.disabled ||
              ...
              !this.visible ||
              ((s =
                !(i = rt(n, this, this.options.tolerance, o)) && this.isover
                  ? 'isout'
                  : i && !this.isover
                  ? 'isover'
                  : null) &&
              ...
              this.selectees.each(function () {
                ...
                t &&
                  ...
                  'touch' === o.tolerance
                    ...
                    : 'fit' === o.tolerance &&
                      (e =
                        i.left > r && l > i.right && i.top > a && c > i.bottom),
                  e
                    ? (t.selected &&
        ...
        _mouseCapture: function (t) {
          ...
          return (
            ...
            this.handles.each(function (t) {
              ...
              (e < s ||
                (s === e &&
                  (t === a._lastChangedValue || a.values(t) === l.min))) &&
                ((s = e), (n = x(this)), (o = t));
            }),
            !1 !== this._start(t, o) &&
              ...
              n.trigger('focus'),
              (e = n.offset()),
              (r = !x(t.target).parents().addBack().is('.ui-slider-handle')),
              (this._clickOffset = r
                ? { left: 0, top: 0 }
                : {
            ...
            ? this.handles.each(function (t) {
                (i =
                  ...
                  (c['horizontal' === a.orientation ? 'left' : 'bottom'] =
                    i + '%'),
                  x(this).stop(1, 1)[l ? 'animate' : 'css'](c, r.animate),
                  !0 === a.options.range &&
      ...
      x.widget('ui.sortable', x.ui.mouse, {
        ...
        _mouseCapture: function (t, e) {
          ...
          return (
            ...
            x(t.target)
              .parents()
              .each(function () {
                return x.data(this, n.widgetName + '-item') === n
                  ? ((i = x(this)), !1)
                  : void 0;
              }),
            !!(i =
              x.data(t.target, n.widgetName + '-item') === n
                ? x(t.target)
                : i) &&
              !(
                this.options.handle &&
        ...
        _getItemsAsjQuery: function (t) {
          ...
          if (l && t)
            for (i = l.length - 1; 0 <= i; i--)
              for (s = (n = x(l[i], this.document[0])).length - 1; 0 <= s; s--)
                (o = x.data(n[s], this.widgetFullName)) &&
                  o !== this &&
                  !o.options.disabled &&
                  a.push([
        ...
        _refreshItems: function (t) {
          ...
          for (e = h.length - 1; 0 <= e; e--)
            for (o = h[e][1], l = (r = h[e][(i = 0)]).length; i < l; i++)
          ...
          for (
            ...
            if (!x.contains(this.currentItem[0], this.containers[d].element[0]))
              if (this._intersectsWith(this.containers[d].containerCache)) {
                if (
                  h &&
                  x.contains(this.containers[d].element[0], h.element[0])
                )
                  continue;
          ...
          if (h)
            if (1 === this.containers.length)
              ...
              for (
                i = 1e4,
                  s = null,
                  n = (l = h.floating || this._isFloating(this.currentItem))
                    ? 'left'
                    : 'top',
                  o = l ? 'width' : 'height',
                  c = l ? 'pageX' : 'pageY',
      ...
      x.widget('ui.tabs', {
            ...
            null === i &&
              (s &&
                this.tabs.each(function (t, e) {
                  return x(e).attr('aria-controls') === s
                    ? ((i = t), !1)
                    : void 0;
                }),
              (null !==
          ...
          (this.tablist = this._getList().attr('role', 'tablist')),
            ...
            this.anchors.each(function (t, e) {
              ...
              l._isLocal(e)
                ...
                : ((n = r.attr('aria-controls') || x({}).uniqueId()[0].id),
        ...
        load: function (t, s) {
          ...
          var o = this,
            ...
            a = { tab: i, panel: r };
          this._isLocal(t[0]) ||
            ((this.xhr = x.ajax(this._ajaxSettings(t, s, a))),
            this.xhr &&
  ...
  (function (t) {
    ...
    var s =
      ((t.prototype.init = function (t, e) {
        return (
          (this.$elem = b(e)),
          (this.options = b.extend({}, b.fn.barrating.defaults, t)),
          this.options
        );
      }),
      t);
    function t() {
      function o(t, e) {
        null !== e && 'object' == typeof e
          ? d.$elem.data('barrating', e)
          : (d.$elem.data('barrating')[t] = e);
      }
      function e() {
        var t = (s = d.options.initialRating)
            ? p(s)
            : b('option:selected', d.$elem),
          e =
            !(n = d.$elem.find('option[value="' + d.options.emptyValue + '"]'))
              .length && d.options.allowEmpty
              ? (n = b('<option />', {
                  value: d.options.emptyValue,
                })).prependTo(d.$elem)
              : n,
          i = t.val(),
          s = t.data('html') ? t.data('html') : t.text(),
          n = null !== d.options.allowEmpty ? d.options.allowEmpty : !!e.length,
          t = e.length ? e.val() : null,
          e = e.length ? e.text() : null;
        o(null, {
          userOptions: d.options,
          ratingValue: i,
          ratingText: s,
          originalRatingValue: i,
          originalRatingText: s,
          allowEmpty: n,
          emptyRatingValue: t,
          emptyRatingText: e,
          readOnly: d.options.readonly,
          ratingMade: !1,
        });
      }
      function r() {
      ...
      function n() {
        return f('userOptions').reverse ? 'nextAll' : 'prevAll';
      }
      function l(t) {
        p(t).prop('selected', !0),
          f('userOptions').triggerChange && d.$elem.change();
      }
      function c(t) {
        (t = t || r()) == f('emptyRatingText') && (t = ''),
          d.options.showSelectedRating &&
            d.$elem.parent().find('.br-current-rating').text(t);
      }
      function h() {
        d.$widget.find('a').removeClass(function (t, e) {
          return (e.match(/(^|\s)br-\S+/g) || []).join(' ');
        });
      }
      function u() {
        var t = d.$widget.find('a[data-rating-value="' + a() + '"]'),
          e = f('userOptions').initialRating,
          i = b.isNumeric(a()) ? a() : 0,
          s = Math.round(((Math.floor(10 * e) / 10) % 1) * 100);
        h(),
          t.addClass('br-selected br-current')[n()]().addClass('br-selected'),
          !f('ratingMade') &&
            b.isNumeric(e) &&
            (e <= i ||
              !s ||
              ((i = d.$widget.find('a')),
              (i = t.length
                ? t[f('userOptions').reverse ? 'prev' : 'next']()
                : i[f('userOptions').reverse ? 'last' : 'first']()).addClass(
                'br-fractional'
              ),
      ...
      function i(t) {
        var e = d.$widget.find('a');
        f('userOptions').fastClicks &&
          e.on('touchstart.barrating', function (t) {
            t.preventDefault(), t.stopPropagation(), b(this).click();
          }),
          t
            ? (s(e),
              e.on('click.barrating', function (t) {
                t.preventDefault();
              }))
            : (g((e = e)), d.options.hoverState && (m(e), v(e)));
      }
      var d = this,
        p = function (t) {
          return (
            b.isNumeric(t) && (t = Math.floor(t)),
            b('option[value="' + t + '"]', d.$elem)
          );
        },
        f = function (t) {
          var e = d.$elem.data('barrating');
        ...
        g = function (t) {
          t.on('click.barrating', function (t) {
            ...
            return (
              t.preventDefault(),
              (e = s.attr('data-rating-value')),
              (i = s.attr('data-rating-text')),
              (s = s),
              !f('allowEmpty') ||
                !f('userOptions').deselectable ||
                a() != s.attr('data-rating-value') ||
                ((e = f('emptyRatingValue')), (i = f('emptyRatingText'))),
              o('ratingValue', e),
              o('ratingText', i),
              o('ratingMade', !0),
              l(e),
        ...
        m = function (t) {
          t.on('mouseenter.barrating', function () {
            var t = b(this);
            h(),
              t.addClass('br-active')[n()]().addClass('br-active'),
              c(t.attr('data-rating-text'));
          });
        },
        v = function (t) {
          d.$widget.on('mouseleave.barrating blur.barrating', function () {
            c(), u();
          });
        };
      (this.show = function () {
        ...
        f() ||
          ((t = ['br-wrapper']),
          '' !== d.options.theme && t.push('br-theme-' + d.options.theme),
          d.$elem.wrap(b('<div />', { class: t.join(' ') })),
          e(),
          (d.$widget =
            ((s = b('<div />', { class: 'br-widget' })),
            d.$elem.find('option').each(function () {
              var t,
                e,
                i = b(this).val();
              i !== f('emptyRatingValue') &&
                ((e = b(this).text()),
                (t = b(this).data('html')),
                (e = b('<a />', {
                  href: '#',
                  'data-rating-value': i,
                  'data-rating-text': (e = t ? t : e),
                  html: d.options.showValues ? e : '',
                })),
                s.append(e));
            }),
            d.options.showSelectedRating &&
              s.append(b('<div />', { text: '', class: 'br-current-rating' })),
            d.options.reverse && s.addClass('br-reverse'),
            d.options.readonly && s.addClass('br-readonly'),
            s)),
          d.$widget.insertAfter(d.$elem),
          u(),
          c(),
          i(d.options.readonly),
          d.$elem.hide());
      }),
        (this.readonly = function (t) {
          'boolean' == typeof t &&
            f('readOnly') != t &&
            (i(t), o('readOnly', t), d.$widget.toggleClass('br-readonly'));
        }),
        (this.set = function (t) {
          var e = f('userOptions');
          0 !== d.$elem.find('option[value="' + t + '"]').length &&
            (o('ratingValue', t),
            o('ratingText', d.$elem.find('option[value="' + t + '"]').text()),
            o('ratingMade', !0),
            l(a()),
            c(r()),
            u(),
            e.silent || e.onSelect.call(this, a(), r()));
        }),
        (this.clear = function () {
          var t = f('userOptions');
          o('ratingValue', f('originalRatingValue')),
            o('ratingText', f('originalRatingText')),
            o('ratingMade', !1),
            b('option', d.$elem).prop('selected', function () {
              return this.defaultSelected;
            }),
            f('userOptions').triggerChange && d.$elem.change(),
            c(r()),
            u(),
            t.onClear.call(this, a(), r());
        }),
        (this.destroy = function () {
          ...
          s(d.$widget.find('a')),
            d.$widget.remove(),
            d.$elem.removeData('barrating'),
            d.$elem.unwrap(),
            d.$elem.show(),
            i.onDestroy.call(this, t, e);
        });
    }
    (b.fn.barrating = function (e, i) {
      return this.each(function () {
        var t = new s();
        return (
          b(this).is('select') ||
            b.error('Sorry, this plugin only works with select fields.'),
          t.hasOwnProperty(e)
            ? (t.init(i, this),
              'show' === e
                ? t.show(i)
                : t.$elem.data('barrating')
                ? ((t.$widget = b(this).next('.br-widget')), t[e](i))
                : void 0)
            : 'object' != typeof e && e
            ? void b.error(
                'Method ' + e + ' does not exist on jQuery.barrating'
              )
            : ((i = e), t.init(i, this), t.show())
        );
      });
    }),
      (b.fn.barrating.defaults = {
        theme: '',
        initialRating: null,
        allowEmpty: null,
        emptyValue: '',
                    ...
                    return (
                      this.isSidebarFitsViewport()
                        ...
                        ? ((t.translateY = t.containerBottom - e),
                          (n = 'CONTAINER-BOTTOM'))
                        : e + t.translateY <= s
                        ? ((t.translateY = s - e), (n = 'VIEWPORT-BOTTOM'))
                      ...
                      if ((this.affixedType != e || t) && e) {
                        var s,
                          ...
                          t =
                            ...
                            a;
                        for (s in (l.eventTrigger(this.sidebar, t),
                        'STATIC' === e
                          ? l.removeClass(
                              this.sidebar,
                        ...
                        for (n in i.inner) {
                          var r = 'number' == typeof i.inner[n] ? 'px' : '';
                          this.sidebarInner.style[n] = i.inner[n] + r;
                        }
                        t =
                          'affixed.' +
                          e.toLowerCase().replace('viewport-', '') +
        ...
        e(function (t, e) {
          (function (t) {
            ...
            'undefined' != typeof window &&
              ((n = 'stickySidebar'),
              (s = window.$ || window.jQuery || window.Zepto) &&
                ((s.fn.stickySidebar = function (i) {
                  return this.each(function () {
                    ...
                    if (
                      (e ||
                        ((e = new o.default(this, 'object' == typeof i && i)),
                        t.data(n, e)),
                      'string' == typeof i)
                    ) {
                      if (
                ...
                (s.fn.stickySidebar.Constructor = o.default),
                (i = s.fn.stickySidebar),
                (s.fn.stickySidebar.noConflict = function () {
                  return (s.fn.stickySidebar = i), this;
                })));
          })(i);
        })
      )
      ...
      (f.fn.zoom = function (i) {
        return this.each(function () {
          ...
          if (!n.url) {
            ...
            if (
              (e &&
                (n.url = e.getAttribute('data-src') || e.currentSrc || e.src),
              !n.url)
            )
              return;
          }
              ...
              function e(t) {
                s.init(),
                  ...
                  l
                    .stop()
                    .fadeTo(
                      f.support.opacity ? n.duration : 0,
                      1,
                      !!f.isFunction(n.onZoomIn) && n.onZoomIn.call(a)
                    );
              }
              function i() {
                l.stop().fadeTo(
                  n.duration,
                  0,
                  !!f.isFunction(n.onZoomOut) && n.onZoomOut.call(a)
                );
              }
              var s = f.zoom(o, t, a, n.magnify);
              'grab' === n.on
                ? r.on('mousedown.zoom', function (t) {
                    1 === t.which &&
                      (f(document).one('mouseup.zoom', function () {
                        i(), f(document).off(c, s.move);
                      }),
                      e(t),
                      f(document).on(c, s.move),
                      t.preventDefault());
                  })
                : 'click' === n.on
                ...
                f.isFunction(n.callback) && n.callback.call(a);
            }),
    ...
    (s = 0),
          ...
          for (
            ...
            for (
              ...
              for (
                ...
                var h = t * i + (a * s.options.slidesPerRow + c);
      ...
      (o.prototype.getSlideCount = function () {
        ...
        return !0 === s.options.swipeToSlide
          ? (s.$slideTrack.find('.slick-slide').each(function (t, e) {
              if (e.offsetLeft - n + c(e).outerWidth() / 2 > -1 * s.swipeLeft)
                return (i = e), !1;
            }),
      ...
      (o.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var n = e - 1, r = i, a = o.$slider.find('.slick-slide'), l = 0;
          ...
          !0 === n.options.centerMode
            ...
            : ((s = n.slideCount % n.options.slidesToShow),
              ...
              n.slideCount - t < n.options.slidesToShow
                ? o.slice(e - (n.options.slidesToShow - s), e + s)
        ...
        return (
          ...
          !s.options.verticalSwiping && !s.swiping && 4 < i
            ...
            : (!0 === s.options.verticalSwiping &&
              ...
              !1 === s.options.vertical
                ? (s.swipeLeft = e + t * i)
                : (s.swipeLeft = e + t * (s.$list.height() / s.listWidth) * i),
              !0 === s.options.verticalSwiping && (s.swipeLeft = e + t * i),
              !0 !== s.options.fade &&
  ...
  (function (f) {
    f.fn.theiaStickySidebar = function (t) {
      function e(t, e) {
        return (
          !0 === t.initialized ||
          (!(f('body').width() < t.minWidth) &&
            ((e = e),
            ((d = t).initialized = !0),
            0 === f('#theia-sticky-sidebar-stylesheet-' + d.namespace).length &&
              f('head').append(
                f(
            ...
            e.each(function () {
              ...
              (t.sidebar = f(this)),
                (t.options = d || {}),
                (t.container = f(t.options.containerSelector)),
              ...
              t.stickySidebar.css('padding-top', 1),
                ...
                (o -= t.stickySidebar.offset().top),
                (r = t.stickySidebar.outerHeight() - r - o),
                0 == o
                ...
                (t.onScroll = function (t) {
                  if (t.stickySidebar.is(':visible'))
                    if (f('body').width() < t.options.minWidth) u();
                    else {
                      ...
                      a >=
                        ...
                        (c =
                          ...
                          f(window).height()
                            ...
                            : f(window).height() -
                              ...
                              d.additionalMarginBottom),
                        (i = n - a + t.paddingTop),
                        (o = s - a - t.paddingBottom - t.marginBottom),
                        (n = t.stickySidebar.offset().top - a),
                        (s = t.previousScrollTop - a),
                        'fixed' == t.stickySidebar.css('position') &&
                          'modern' == t.options.sidebarBehavior &&
                          (n += s),
                        'stick-to-top' == t.options.sidebarBehavior &&
                          (n = d.additionalMarginTop),
                        'stick-to-bottom' == t.options.sidebarBehavior &&
                          (n = c - t.stickySidebar.outerHeight()),
                        (n =
                          0 < s
                            ? Math.min(n, e)
                            : Math.max(n, c - t.stickySidebar.outerHeight())),
                        (n = Math.max(n, i)),
                        ...
                        (l =
                          (!(o =
                            ...
                            n == e) ||
                          (!o && n == c - t.stickySidebar.outerHeight())
                            ? 'fixed'
                            : a + n - t.sidebar.offset().top - t.paddingTop <=
                              d.additionalMarginTop
                            ? 'static'
                            : 'absolute')),
                        'fixed' == l
                          ? ((r = f(document).scrollLeft()),
                            t.stickySidebar.css({
                              position: 'fixed',
  ...
  (function (h) {
    ...
    Object.keys ||
      (Object.keys = (function () {
        ...
        return function (t) {
          ...
          if (o) for (i = 0; i < a; i++) n.call(t, r[i]) && s.push(r[i]);
          return s;
        };
      })());
    var v = !1;
    ...
    function y(t, e, i, s, n) {
      for (
        var o = {}, r = {}, a = {}, l = {}, c = {}, h = {}, u = null, d = 0;
        d < s.length;
        d++
      ) {
        var p = s[d],
          f = null === u ? i / _[p] : _[u] / _[p],
          g = t / _[p],
          m = e / _[p];
        n &&
          ((g = 0 < g ? Math.floor(g) : Math.ceil(g)),
          (m = 0 < m ? Math.floor(m) : Math.ceil(m))),
          'Days' !== p && ((g %= f), (m %= f)),
          (o[p] = g),
          (a[p] = Math.abs(g)),
          (r[p] = m),
    ...
    var o = {};
    function r() {
      void 0 !== m.TC_Instance_List
        ? (o = m.TC_Instance_List)
        : (m.TC_Instance_List = o),
        (function (r) {
          for (
            ...
            (r.requestAnimationFrame = r[t[e] + 'RequestAnimationFrame']),
              (r.cancelAnimationFrame = r[t[e] + 'CancelAnimationFrame']);
          (r.requestAnimationFrame && r.cancelAnimationFrame) ||
            ((r.requestAnimationFrame = function (t, e, i) {
              ...
              return (i.data.last_frame = s + n), o;
            }),
    ...
    (a.prototype.clearListeners = function () {
      ...
      (a.prototype.addTime = function (t) {
        var e;
        this.data.attributes.ref_date instanceof Date
          ? (e = this.data.attributes.ref_date).setSeconds(e.getSeconds() + t)
      ...
      (a.prototype.initialize = function (t) {
        ...
        h(this.element).children('div.time_circles').remove(),
          (!(t = void 0 === t ? !0 : t) && null !== this.listeners) ||
            this.clearListeners(),
        ...
        0 === s && (s = h(this.element).height()),
          0 === n && (n = h(this.element).width()),
          0 === s && 0 < n
            ? (s = n / this.data.drawn_units.length)
            : 0 === n && 0 < s && (n = s * this.data.drawn_units.length);
        var o = document.createElement('canvas');
        (o.width = n),
          (o.height = s),
          (this.data.attributes.canvas = h(o)),
        ...
        t ||
          ...
          (G_vmlCanvasManager.initElement(o), (t = v = !0)),
          t && (this.data.attributes.context = o.getContext('2d')),
          (this.data.attributes.item_size = Math.min(
            n / this.data.drawn_units.length,
            s
          )),
        ...
        var r,
          ...
          l,
          e = 0;
        for (r in this.data.text_elements)
          this.config.time[r].show &&
            ((a = h('<div>')).addClass('textDiv_' + r),
            ...
            (l = h('<h4>')).text(this.config.time[r].text),
            l.css(
              'font-size',
      ...
      (a.prototype.update = function (t) {
        ...
        var e = this.data.prev_time,
          i = new Date();
        if (
          ((this.data.prev_time = i),
          null === e && (e = i),
          !this.config.count_past_zero && i > this.data.attributes.ref_date)
        ) {
          for (var s = 0; s < this.data.drawn_units.length; s++) {
            var n = this.data.drawn_units[s];
            this.data.text_elements[n].text('0');
            var o =
                s * this.data.attributes.item_size +
                this.data.attributes.item_size / 2,
              r = this.data.attributes.item_size / 2,
              a = this.config.time[n].color;
            this.drawArc(o, r, a, 0);
          }
          this.stop();
        } else {
          var l,
            c,
            h = (this.data.attributes.ref_date - i) / 1e3,
            i = (this.data.attributes.ref_date - e) / 1e3,
            e = 'smooth' !== this.config.animation,
            u = y(h, i, this.data.total_duration, this.data.drawn_units, e),
            d = y(h, i, _.Years, b, e),
            s = 0,
            p = 0,
            f = null,
            g = this.data.drawn_units.slice();
          for (s in b) {
            n = b[s];
            Math.floor(d.raw_time[n]) !== Math.floor(d.raw_old_time[n]) &&
              ...
              g.indexOf(n) < 0 ||
                (Math.floor(u.raw_time[n]) !== Math.floor(u.raw_old_time[n]) &&
                  this.notifyListeners(
                    n,
                    Math.floor(u.time[n]),
                    Math.floor(h),
                ...
                t ||
                  (this.data.text_elements[n].text(
                    Math.floor(Math.abs(u.time[n]))
                  ),
                  (o =
                    p * this.data.attributes.item_size +
                    this.data.attributes.item_size / 2),
                  (r = this.data.attributes.item_size / 2),
                  (a = this.config.time[n].color),
                  'smooth' === this.config.animation
                    ? (null === f ||
                        v ||
                        (Math.floor(u.time[f]) > Math.floor(u.old_time[f])
                          ? (this.radialFade(o, r, a, 1, n),
                            (this.data.state.fading[n] = !0))
                          : Math.floor(u.time[f]) < Math.floor(u.old_time[f]) &&
                            (this.radialFade(o, r, a, 0, n),
                            (this.data.state.fading[n] = !0))),
                      this.data.state.fading[n] ||
                        this.drawArc(o, r, a, u.pct[n]))
                    : this.animateArc(
                        o,
                        r,
                        a,
          ...
          this.data.paused ||
            ...
            'smooth' === (l = this).config.animation
              ...
              : ((e = (h % 1) * 1e3) < 0 && (e = 1e3 + e),
                (l.data.animation_frame = m.setTimeout(function () {
                  l.data.animation_frame = m.requestAnimationFrame(
                    c,
                    l.element,
                    l
                  );
      ...
      (a.prototype.animateArc = function (t, e, i, s, n, o) {
        var r, a;
        null !== this.data.attributes.context &&
          (0.5 < Math.abs(n - s)
            ? 0 === s
              ? this.radialFade(t, e, i, 1)
              : this.radialFade(t, e, i, 0)
            : ((r = (200 - (o - new Date().getTime())) / 200),
              this.drawArc(t, e, i, n * (1 - (r = 1 < r ? 1 : r)) + s * r),
              1 <= r ||
                m.requestAnimationFrame(function () {
                  a.animateArc(t, e, i, s, n, o);
                }, (a = this).element)));
      }),
      (a.prototype.drawArc = function (t, e, i, s) {
        var n, o, r;
        null !== this.data.attributes.context &&
          ((r = Math.max(
            this.data.attributes.outer_radius,
          ...
          v ||
            this.data.attributes.context.clearRect(t - r, e - r, 2 * r, 2 * r),
          ...
          (o = -0.5 * Math.PI),
          (r = 2 * Math.PI),
          (r = o + (this.config.start_angle / 360) * r),
          (s = 2 * s * Math.PI),
          (s =
      ...
      (a.prototype.radialFade = function (i, s, t, n, e) {
        for (
          var o =
              ((t = (t = t).replace(
                /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
      ...
      (a.prototype.start = function () {
        ...
        var t = h(this.element).data('date');
        'string' ==
        typeof (t = void 0 === t ? h(this.element).attr('data-date') : t)
          ? (this.data.attributes.ref_date = (function (t) {
              ...
              return (
                (e = Date.parse(t)),
                isNaN(e)
                  ? ((e = Date.parse(t.replace(/-/g, '/').replace('T', ' '))),
                    isNaN(e) ? new Date() : e)
                  : e
              );
            })(t))
          ...
          : 'number' ==
            typeof (t =
              'string' ==
              typeof (t =
                void 0 === (t = h(this.element).data('timer'))
                  ? h(this.element).attr('data-timer')
                  : t)
                ? parseFloat(t)
                : t)
          ? ((this.data.timer = t),
            (this.data.attributes.ref_date = new Date().getTime() + 1e3 * t))
      ...
      (a.prototype.destroy = function () {
        this.clearListeners(),
          ...
          h(this.element).removeAttr('data-tc-id'),
          h(this.element).removeData('tc-id');
      }),
      (a.prototype.setOptions = function (t) {
        if (
          (null === this.config &&
            ((this.default_options.ref_date = new Date()),
            (this.config = h.extend(!0, {}, this.default_options))),
          h.extend(!0, this.config, t),
          (m = this.config.use_top_frame ? window.top : window),
          r(),
          (this.data.total_duration = this.config.total_duration),
          'string' == typeof this.data.total_duration)
        )
          if (void 0 !== _[this.data.total_duration])
            this.data.total_duration = _[this.data.total_duration];
          else if ('Auto' === this.data.total_duration)
            for (var e = 0; e < Object.keys(this.config.time).length; e++) {
              var i = Object.keys(this.config.time)[e];
              if (this.config.time[i].show) {
                this.data.total_duration = _[s[i]];
                break;
              }
            }
          else
            (this.data.total_duration = _.Years),
              console.error(
      ...
      (a.prototype.addListener = function (t, e, i) {
        'function' == typeof t &&
          this.listeners[(i = void 0 === i ? 'visible' : i)].push({
            func: t,
            scope: e,
          });
      }),
      (a.prototype.notifyListeners = function (t, e, i, s) {
        for (var n = 0; n < this.listeners[s].length; n++) {
          var o = this.listeners[s][n];
      ...
      return (
        void 0 === s &&
          ((s =
            ...
            n() +
            n()),
          h(t).attr('data-tc-id', s)),
        void 0 === o[s]
          ? ((e = this.options),
            'object' ==
              typeof (i =
                'string' == typeof (i = h(t).data('options'))
                  ? JSON.parse(i)
                  : i) && (e = h.extend(!0, {}, this.options, i)),
            (e = new a(t, e)),
            (o[s] = e))
          : ((e = o[s]), void 0 !== this.options && e.setOptions(this.options)),
        e
      );
    }),
  ...
  function () {
    ...
    (e = this),
      (i = function (l, o) {
        var e, n, r, a, i, c, h, s, u, d, p, f, g, m, v, b;
        function t(t) {
          var e = this;
          (this.$element = t),
            (this.element = t[0]),
        ...
        function _(t, e, i) {
          'bottom-in-view' === (i = l.extend({}, l.fn[v].defaults, i)).offset &&
            (i.offset = function () {
              ...
              return (
                (t = !l.isWindow(e.element) ? e.$element.height() : t) -
                l(this).outerHeight()
              );
            }),
            (this.$element = t),
            ...
            (i = null != (i = t.data(m)) ? i : []).push(this.id),
            t.data(m, i);
        }
        return (
          (e = l(o)),
          (s = 0 <= y.call(o, 'ontouchstart')),
              ...
              l.each(t, function (t, s) {
                ...
                return (
                  l.each(o.waypoints[t], function (t, e) {
                    var i;
                    return (s.oldScroll < (i = e.offset) && i <= s.newScroll) ||
                      (s.newScroll < (i = e.offset) && i <= s.oldScroll)
                      ? n.push(e)
                      : void 0;
                  }),
                  n.sort(function (t, e) {
              ...
              l.each(t, function (t, a) {
                return l.each(e.waypoints[t], function (t, e) {
                  ...
                  if (
                    ...
                    (e.offset = r - a.contextOffset + a.contextScroll - n),
                    (!e.options.onlyOnScroll || null == o) && e.enabled)
                  )
                    return null !== o && o < (i = a.oldScroll) && i <= e.offset
          ...
          (_.getWaypointsByElement = function (t) {
            var e,
              t = l(t).data(m);
            return t
              ? ((e = l.extend({}, a.horizontal, a.vertical)),
                l.map(t, function (t) {
                  return e[t];
                }))
              : [];
          ...
          (d = {
            init: function (t, s) {
              return (
                null == (s = null == s ? {} : s).handler && (s.handler = t),
                this.each(function () {
                  var t,
                    e = l(this),
                    i = null != (t = s.context) ? t : l.fn[v].defaults.context;
                  return (
                    l.isWindow(i) || (i = e.closest(i)),
                    (i = l(i)),
                    (t = (t = h[i.data(c)]) || new n(i)),
                    new r(e, t, s)
                  );
                }),
                l[b]('refresh'),
  ...
  (function (z) {
    ...
    z(window).on('load', function () {
      ...
      z(window).on('scroll', function () {
        300 < z(this).scrollTop()
          ? z('.header-sticky').addClass('sticky')
          : z('.header-sticky').removeClass('sticky');
      });
    var i = z('.global-overlay');
    z('.toolbar-btn').on('click', function (t) {
      t.preventDefault(), t.stopPropagation();
      var e = z(this),
        t = e.attr('href'),
        e = e.parent().siblings().children('.toolbar-btn').attr('href');
      z(t).toggleClass('open'),
        z(e).removeClass('open'),
        z(i).addClass('overlay-open');
    }),
      (W = z('body')).on('click', function (t) {
        var e = t.target,
          t = z('.main-wrapper').children();
        z(e).is('.toolbar-btn') ||
          z(e).parents().is('.open') ||
          (t.removeClass('open'),
          t.find('.open').removeClass('open'),
          i.removeClass('overlay-open'));
      }),
      z('.btn-close').on('click', function (t) {
        t.preventDefault(), z(this).parents('.open').removeClass('open');
      });
    var t = z(
    ...
    e
      ...
      e.slideUp(),
      t.on('click', 'li a, li .menu-expand', function (t) {
        var e = z(this);
        e
          .parent()
          .attr('class')
          ...
          ('#' === e.attr('href') ||
            '' === e.attr('href') ||
            e.hasClass('menu-expand')) &&
          (t.preventDefault(),
          e.siblings('ul:visible').length
            ? e.siblings('ul').slideUp('slow')
            : (e
                .closest('li')
                .siblings('li')
                .find('ul:visible')
                .slideUp('slow'),
              e.closest('li').siblings('li').removeClass('menu-open'),
              e.siblings('ul').slideDown('slow'),
              e.parent().siblings().children('ul').slideUp())),
          e.is('a') ||
          e.is('span') ||
          e.attr('class').match(/\b(menu-expand)\b/)
            ? e.parent().toggleClass('menu-open')
            : e.is('li') &&
              e.attr('class').match(/\b('menu-item-has-children')\b/) &&
              e.toggleClass('menu-open');
      }),
      z('.btn-close').on('click', function (t) {
        t.preventDefault(),
          z('.mobile-menu .sub-menu').slideUp(),
          z('.mobile-menu .menu-item-has-children').removeClass('menu-open');
      }),
      z(document).ready(function () {
        z('.nice-select').niceSelect();
      }),
      (z.fn.elExists = function () {
        return 0 < this.length;
      }),
      z('.countdown').elExists &&
        z('.countdown').each(function () {
          var t = z(this),
            e = z(this).data('countdown'),
            i = z(this).data('format');
          setInterval(function () {
            !(function (t, e, i) {
              var s = new Date(),
                n = (new Date(t).getTime() - s.getTime()) / 864e5,
                o = Math.floor(n),
                r = 24 * (n - o),
                a = Math.floor(r),
                l = 60 * (r - a),
                ...
                p = 0;
              'short' != i &&
                (365 < o && ((u = Math.floor(o / 365)), (o %= 365)),
                30 < o && ((d = Math.floor(o / 30)), (o %= 30)),
                7 < o && ((p = Math.floor(o / 7)), (o %= 7)));
              var f = 1 < (u = u < 10 ? '0' + u : u) ? 'years' : 'year',
                g = 1 < (d = d < 10 ? '0' + d : d) ? 'months' : 'month',
                m = 1 < (p = p < 10 ? '0' + p : p) ? 'weeks' : 'week',
                t = 1 < (o = o < 10 ? '0' + o : o) ? 'days' : 'day',
                s = 1 < (a = a < 10 ? '0' + a : a) ? 'hrs' : 'hr',
                n = 1 < (c = c < 10 ? '0' + c : c) ? 'mins' : 'min',
                r = 1 < (h = h < 10 ? '0' + h : h) ? 'secs' : 'sec',
                i = (l = {
                  wrapper: e.find('.countdown__item'),
                  year: e.find('.yearsLeft'),
                  month: e.find('.monthsLeft'),
                  week: e.find('.weeksLeft'),
                  day: e.find('.daysLeft'),
                  hour: e.find('.hoursLeft'),
                  minute: e.find('.minsLeft'),
                  second: e.find('.secsLeft'),
                  yearTxt: e.find('.yearsText'),
                  monthTxt: e.find('.monthsText'),
                  weekTxt: e.find('.weeksText'),
                  dayTxt: e.find('.daysText'),
                  hourTxt: e.find('.hoursText'),
                  minTxt: e.find('.minsText'),
                  secTxt: e.find('.secsText'),
                }).wrapper.length;
              e.addClass('item-' + i),
                z(l.year).html(u),
                z(l.yearTxt).html(f),
      ...
      z('.cart-plus-minus').append(
        '<div class="dec qtybutton"><i class="fa fa-angle-down"></i></div><div class="inc qtybutton"><i class="fa fa-angle-up"></i></div>'
      ),
      z('.qtybutton').on('click', function () {
        var t = z(this),
      ...
      z('#showlogin').on('click', function () {
        z('#checkout-login').slideToggle(900);
      }),
      z('#showcoupon').on('click', function () {
        z('#checkout_coupon').slideToggle(900);
      }),
      z('#cbox').on('click', function () {
        z('#cbox-info').slideToggle(900);
      }),
      z('#ship-box').on('click', function () {
        z('#ship-box-info').slideToggle(1e3);
      }),
      z('.card-header a').on('click', function () {
        z('.card').removeClass('actives'),
          z(this).parents('.card').addClass('actives');
      }),
      z('.count').counterUp({ delay: 10, time: 1e3 }),
      z(window).on({
        load: function () {
          z('.product-view-mode a.active'),
            z('.product-view-mode').children().first();
          z(window).width() < 768 &&
            (z('.product-view-mode a').removeClass('active'),
            z('.product-view-mode').children().first().addClass('active'),
            z('.shop-product-wrap')
              .removeClass('gridview-3 gridview-4 gridview-5')
              .addClass('gridview-2'));
        },
        resize: function () {
          var t = z(window).width(),
            e = z('.product-view-mode a.active'),
            i =
              (z('.product-view-mode').children().first(),
              z('.product-view-mode').data('default'));
          t < 1200 &&
            575 < t &&
            e.hasClass('grid-5') &&
            (z('.product-view-mode a.grid-5').removeClass('active'),
            4 == i
              ? (z('.product-view-mode a.grid-4').addClass('active'),
                z('.shop-product-wrap')
                  .removeClass('gridview-2 gridview-3 gridview-5')
                  .addClass('gridview-4'))
              : 'list' == i
              ? (z('.product-view-mode a.list').addClass('active'),
                z('.shop-product-wrap')
                  .removeClass('gridview-2 gridview-3 gridview-4 gridview-5')
                  .addClass('listview'))
              : (z('.product-view-mode a.grid-3').addClass('active'),
                z('.shop-product-wrap')
            ...
            t < 768 &&
              575 < t &&
              e.hasClass('grid-4') &&
              (z('.product-view-mode a.grid-4').removeClass('active'),
              'list' == i
                ? (z('.product-view-mode a.list').addClass('active'),
                  z('.shop-product-wrap')
                    .removeClass('gridview-2 gridview-3 gridview-4 gridview-5')
            ...
            e.hasClass('list') ||
              (t < 576
                ...
                : e.hasClass('grid-2') &&
                  (t < 1200
                    ? z('.product-view-mode a:not(:first-child)').removeClass(
                        'active'
                      )
                    : (z('.product-view-mode a').removeClass('active'),
                      z('.product-view-mode a:nth-child(2)').addClass('active'),
                      z('.shop-product-wrap')
                        .removeClass('gridview-2 gridview-4 gridview-5')
                        .addClass('gridview-3'))));
        },
      }),
      z('.product-view-mode a').on('click', function (t) {
        t.preventDefault();
        var e = z('.shop-product-wrap'),
          t = z(this).data('target');
        z('.product-view-mode a').removeClass('active'),
          z(this).addClass('active'),
          'listview' == t
            ? e.removeClass('grid')
            : e.not('.grid') && e.addClass('grid'),
          e
            .removeClass('gridview-2 gridview-3 gridview-4 gridview-5 listview')
            .addClass(t);
      }),
      z(function () {
        z('.star-rating').barrating({ theme: 'fontawesome-stars' });
      }),
      z('#sticky-sidebar').theiaStickySidebar({ additionalMarginTop: 80 }),
      z(function () {
        z('[data-bs-toggle="tooltip"]').tooltip();
      });
    var s = z('#slider-range'),
      n = z('#amount');
    z(function () {
      s.slider({
        range: !0,
        ...
        n.val('$' + s.slider('values', 0) + ' - $' + s.slider('values', 1));
    });
    var j = z('html'),
      W = z('body'),
      t = z('.kenne-element-carousel');
    (z.fn.elExists = function () {
      return 0 < this.length;
    }),
      ('rtl' != j.attr('dir') && 'rtl' != W.attr('dir')) ||
        t.attr('dir', 'rtl'),
      t.elExists() &&
        (('rtl' != j.attr('dir') && 'rtl' != W.attr('dir')) ||
          t.attr('dir', 'rtl'),
        t.each(function (t, e) {
          for (
            var n = z(this),
              i =
                void 0 !== n.data('slick-options')
                  ? n.data('slick-options')
                  : '',
              s = i.spaceBetween ? parseInt(i.spaceBetween, 10) : 0,
              o = i.spaceBetween_xl ? parseInt(i.spaceBetween_xl, 10) : 0,
              r =
                (i.rowSpace && parseInt(i.rowSpace, 10),
                i.rows,
                i.vertical || !1),
              a = i.focusOnSelect || !1,
              l = i.pauseOnHover || !1,
              ...
              u = i.fade || !1,
              d = i.autoplay || !1,
              p = i.autoplaySpeed ? parseInt(i.autoplaySpeed, 10) : 5e3,
              f = i.swipe || !0,
              g = i.swipeToSlide || !0,
              m = i.touchMove || !1,
              v = (i.verticalSwiping, i.draggable || !0),
              b = i.arrows || !1,
              _ = i.dots || !1,
              y = i.adaptiveHeight || !0,
              w = i.infinite || !1,
              x = i.centerMode || !1,
              k = i.centerPadding || '',
              C = i.variableWidth || !1,
              T = i.speed ? parseInt(i.speed, 10) : 500,
              S = i.appendArrows || n,
              D =
                !0 === b
                  ? i.prevArrow
                    ? '<span class="' +
                      i.prevArrow.buttonClass +
                      '"><i class="' +
                      i.prevArrow.iconClass +
                      '"></i></span>'
              ...
              E =
                !0 === b
                  ? i.nextArrow
                    ? '<span class="' +
                      i.nextArrow.buttonClass +
                      '"><i class="' +
                      i.nextArrow.iconClass +
                      '"></i></span>'
                    : '<button class="tty-slick-text-btn tty-slick-text-next"><i class="ion-ios-arrow-forward"></i></span>'
                  : '',
              A = i.rows ? parseInt(i.rows, 10) : 1,
              I = !!(i.rtl || j.attr('dir="rtl"') || W.attr('dir="rtl"')),
              O = i.slidesToShow ? parseInt(i.slidesToShow, 10) : 1,
              i = i.slidesToScroll ? parseInt(i.slidesToScroll, 10) : 1,
              M =
                void 0 !== n.data('slick-responsive')
                  ? n.data('slick-responsive')
                  : '',
              P = M.length,
              N = [],
              H = 0;
          ...
          n.addClass('slick-carousel-' + t),
            ...
            n
              ...
              .find('.slick-btn')
              .addClass('btn-' + t),
            0 != s && n.addClass('slick-gutter-' + s),
            0 != o && n.addClass('slick-gutter-xl-' + o);
          function L(t) {
            t.each(function () {
              var t = z(this),
                e = t.data('delay'),
              ...
              t.css({ 'animation-delay': e, 'animation-duration': i }),
                t
                  .addClass(s)
                  .one(
          ...
          n.on('init', function (t, e) {
            n.find('.slick-active').first().addClass('first-active'),
              n.find('.slick-active').last().addClass('last-active'),
              e.slideCount <= O && n.children('.slick-dots').hide(),
              L(z('.slick-slide').find('[data-animation]'));
          }),
            n.slick({
              slidesToShow: O,
              slidesToScroll: i,
            ...
            n.on('beforeChange', function (t, e, i, s) {
              n.find('.slick-active').first().removeClass('first-active'),
                n.find('.slick-active').last().removeClass('last-active'),
                L(
                  z('.slick-slide[data-slick-index="' + s + '"]').find(
                    '[data-animation]'
                  )
                );
            }),
        ...
        z('.single-blog_slider').on('wheel', function (t) {
          t.preventDefault(),
            t.originalEvent.deltaY < 0
              ? z(this).slick('slickNext')
              : z(this).slick('slickPrev');
        })),
      z('.color-list a').on('click', function (t) {
        t.preventDefault();
        t = z(this);
        t.addClass('active'), t.siblings().removeClass('active');
        for (
          var e = document.querySelectorAll('.slick-slider-nav .single-slide'),
            i = document.querySelectorAll('.slick-img-slider .single-slide'),
            s = t.data('swatch-color'),
            n = 0;
          n < e.length;
          n++
        ) {
          var o = a(e[n], '.slick-slide');
          o.classList.remove('slick-current'),
            e[n].classList.contains(s) && o.classList.add('slick-current');
        }
        for (n = 0; n < i.length; n++) {
          var r = a(i[n], '.slick-slide');
          r.classList.remove(
            'slick-current',
            'slick-active',
            'first-active',
    ...
    z('.sidebar-categories_menu li.has-sub > a').on('click', function () {
      z(this).removeAttr('href');
      var t = z(this).parent('li');
      t.hasClass('open')
        ? (t.removeClass('open'),
    ...
    z(function () {
      ...
      o.on('click', function (t) {
        z('html, body').animate({ scrollTop: 0 }, 600), t.preventDefault();
      }),
      z('.DateCountdown').TimeCircles({
        ...
        animation: 'thick',
        time: {
          Days: { text: 'Days', color: '#fff' },
          Hours: { text: 'Hours', color: '#fff' },
          Minutes: { text: 'Mins', color: '#fff' },
          Seconds: { text: 'Secs', color: '#fff' },
        },
      }),
      z(function () {
        var e = z('#contact-form'),
          i = z('.form-message');
        z(e).submit(function (t) {
          t.preventDefault();
          t = z(e).serialize();
          z.ajax({ type: 'POST', url: z(e).attr('action'), data: t })
            .done(function (t) {
              z(i).removeClass('error'),
                z(i).addClass('success'),
                z(i).text(t),
                z('#contact-form input,#contact-form textarea').val('');
            })
            .fail(function (t) {
              z(i).removeClass('success'),
                z(i).addClass('error'),
                '' !== t.responseText
                  ? z(i).text(t.responseText)
                  : z(i).text(
